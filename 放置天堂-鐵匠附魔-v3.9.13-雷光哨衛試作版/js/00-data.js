...
const GAME_VERSION = 'v3.9.71';   // 🏷️ 版本號：末段 0~99 線性遞增，達 100 進位（中位 +1、末段歸 0）
...
// ===== 集中式固定平衡倍率 =====
// 正式版不接受玩家、本機舊設定或匯入存檔調整：經驗恢復原值，金幣與掉落維持減半，戰鬥倍率維持原公式。
const BALANCE_DEFAULTS = Object.freeze({ exp: 1, gold: 0.5, drop: 0.5 });
var GAME_BALANCE = Object.freeze(Object.assign({}, BALANCE_DEFAULTS));
function loadGameBalance() {
  GAME_BALANCE = Object.freeze(Object.assign({}, BALANCE_DEFAULTS));
  return GAME_BALANCE;
}
function balanceMult(key) { return Object.prototype.hasOwnProperty.call(BALANCE_DEFAULTS,key) ? BALANCE_DEFAULTS[key] : 1; }
function setGameBalance(key, value) {
  loadGameBalance();   // 相容舊 onclick／主控台呼叫：忽略輸入並恢復正式固定值
  if (typeof syncPlatformTuningUI === 'function') syncPlatformTuningUI();
}
...
const DB = {
        ...
        "wpn_longsword": { n: "長劍", type: "wpn", dmgS: 8, dmgL: 12, hit: 0, spd: 0.9, req: "knight,elf", safe: 6, p: 4200, gachaWeight: 50, sizeMechanics: { small: { effect: "sweep", every: 4, splashPct: 40, maxTargets: 1 }, large: { effect: "stagger", delayTicks: 3, cooldownTicks: 30 } } },
        "wpn_1": { n: "斧", type: "wpn", dmgS: 3, dmgL: 5, hit: 0, spd: 1, req: "all", safe: 6, p: 28, gachaWeight: 100 },
        "wpn_2hsword": { n: "雙手劍", type: "wpn", w2h: true,dmgS: 14, dmgL: 16, hit: 0, spd: 1, req: "knight", safe: 6, p: 25200, eff: "cleave", sizeMechanics: { small: { effect: "sweep", every: 3, splashPct: 50, maxTargets: 2 }, large: { effect: "stagger", delayTicks: 5, cooldownTicks: 30 } }, gachaWeight: 10 },
        ...
        "wpn_dragonslayer": { n: "屠龍劍", type: "wpn", w2h: true, dmgS: 28, dmgL: 35, hit: 2, dmgBonus: 9, spd: 1, req: "royal,knight,dragon", safe: 6, p: 300000, eff: "cleave", prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 6, cooldownTicks: 30 } } }, dragonStrike: 12, legend: true, gachaWeight: 1, grantSkills: ["sk_four_seal_resonance"], grantSkillsEquipOnly: true, d: "傳說稱它為屠龍之劍。犧牲對小型敵人的橫掃，將大型震盪強化至原型上限；四個凹槽可呼應地、水、火、風封印石。裝備後可使用四印共振：32 秒內全屬性抗性 +15，龍的一擊發動率由 12% 提升至 20%。" },   // 🔧 卡瑞 100% 掉落（🎮 經典模式亦 100%·v2.6.75）；潘朵拉抽不到
        "wpn_vander_sword": { n: "騎士范德之劍", type: "wpn", w2h: true, dmgS: 22, dmgL: 34, hit: 5, dmgBonus: 6, spd: 1, req: "knight", safe: 6, p: 210000, eff: "cleave", prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, str: 1, vanderStunHit: true, legend: true, gachaWeight: 1, d: "闇黑騎士范德生前佩持的雙手巨劍；犧牲橫掃，保留對大型敵人的震盪，將殺意集中在單一強敵。" },
        "wpn_2": { n: "釘錘", type: "wpn", dmgS: 6, dmgL: 8, hit: 0, spd: 1.1, req: "all", safe: 6, p: 133, gachaWeight: 100, sizeMechanics: { small: { effect: "stagger", delayTicks: 3, cooldownTicks: 30 }, large: { effect: "break_stance", defense: 1, durationTicks: 40 } } },
        "wpn_3": { n: "弓", type: "wpn", isBow: true, ranged: true, rapidfire: 20, dmgS: 2, dmgL: 2, hit: 0, spd: 1.0, req: "all", safe: 6, p: 70, gachaWeight: 100, sizeMechanics: { small: { effect: "stagger", delayTicks: 2, cooldownTicks: 30 }, large: { effect: "break_stance", defense: 1, durationTicks: 30 } } },
        "wpn_4": { n: "矛", type: "wpn", dmgS: 6, dmgL: 8, hit: 0, spd: 1, req: "all", safe: 6, p: 120, sizeMechanics: { small: { effect: "pierce", chance: 25, splashPct: 40, maxTargets: 1 }, large: { effect: "break_stance", defense: 2, durationTicks: 50 } }, gachaWeight: 100 },
        "wpn_battleaxe": { n: "戰斧", type: "wpn", w2h: true, dmgS: 18, dmgL: 18, hit: 0, spd: 1.1, req: "knight,elf", safe: 6, p: 980, gachaWeight: 100, eff: "crush", sizeMechanics: { small: { effect: "stagger", delayTicks: 4, cooldownTicks: 30 }, large: { effect: "break_stance", defense: 2, durationTicks: 50 } } },
        ...
        "wpn_dagger1": { n: "歐西斯匕首", type: "wpn", dmgS: 2, dmgL: 3, hit: 2, spd: 0.6, req: "all", safe: 6, p: 10, gachaWeight: 100, sizeMechanics: { small: { effect: "pierce", chance: 15, splashPct: 30, maxTargets: 1 }, large: { effect: "break_stance", defense: 1, durationTicks: 30 } } },
        ...
        "wpn_21": { n: "帕提森", type: "wpn", dmgS: 6, dmgL: 6, hit: 0, spd: 1, req: "knight,elf", safe: 6, p: 700, gachaWeight: 100, sizeMechanics: { small: { effect: "pierce", chance: 20, splashPct: 35, maxTargets: 1 }, large: { effect: "break_stance", defense: 1, durationTicks: 40 } } },
        ...
        "wpn_31": { n: "十字弓", type: "wpn", isBow: true, ranged: true, rapidfire: 50, dmgS: 3, dmgL: 2, hit: 3, dmgBonus: 2, spd: 1.0, req: "knight,elf,dark", safe: 6, p: 59400, gachaWeight: 10, sizeMechanics: { small: { effect: "break_stance", defense: 1, durationTicks: 30 }, large: { effect: "stagger", delayTicks: 3, cooldownTicks: 30 } } },   // 🖤 v3.2.4：黑暗妖精可用改由 req 顯式標示（原靠 DARK_XBOW_LEGACY 通則·通則已刪·現狀保留）
		...
		"wpn_flaming_angel": { n: "熾炎天使弓", type: "wpn", isBow: true, ranged: true, rapidfire: 40, dmgS: 3, dmgL: 3, hit: 3, dmgBonus: 4, spd: 1.0, req: "elf", safe: 6, p: 137300, w2h: true, eff: "moonburst", legend: true, gachaWeight: 1, prototypePolicy: { family: "弓", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "由火焰與羽翼鍛成的傳說長弓。保留對小型敵人的牽制射擊、犧牲大型破勢，月華爆裂仍由原有武器特效處理。" },   // 🔧 潘朵拉抽不到；取得來源：羅賓孫製作、死神(0.001%)、惡魔(0.5%)
        ...
        "wpn_oakwand": { n: "橡木魔法杖", type: "wpn", dmgS: 3, dmgL: 4, hit: 0, spd: 1.0, req: "all", safe: 6, p: 330, gachaWeight: 100, extraMpPerEn: 1, sizeMechanics: { small: { effect: "disrupt", durationTicks: 10, cooldownTicks: 40 }, large: { effect: "stagger", delayTicks: 2, cooldownTicks: 40 } } },
        ...
        "wpn_powerless_baless": { n: "失去魔力的巴列斯魔杖", type: "wpn", dmgS: 1, dmgL: 1, hit: 0, dmgBonus: 0, spd: 1.0, req: "all", safe: 0, p: 100000, gachaWeight: 0, noEnhance: true, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "sacrifice" } }, d: "魔力早已枯竭的古老魔杖。封印狀態犧牲小型施法干擾與大型震盪；使用靈魂之球解封後才恢復正式魔杖原型。無法強化，可販售。" },   // 🔧 巴列斯任務武器；🏛️ noEnhance＝封印恆 +0（傳統模式自帶強化值延後到靈魂之球解封印時附加）
        "wpn_baless": { n: "巴列斯魔杖", type: "wpn", dmgS: 2, dmgL: 3, hit: 0, dmgBonus: 0, mdmg: 2, spd: 1.0, req: "mage", safe: 0, p: 250000, mpR: 10, mpROverSafe: 2, legend: true, gachaWeight: 1, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "keep" } }, grantSkills: ["sk_forbidden_resonance"], grantSkillsEquipOnly: true, d: "杖芯留著象牙塔最高研究室的禁忌術式。犧牲小型施法干擾、保留大型震盪；禁式共鳴維持不變。" },   // 🏅 傳說武器（共鳴：見 WAND_LIGHTARROW_IDS）；🔧 安定值0：+0 為 MP自然恢復10，每強化+1再+2（10/12/14…）
        ...
        // ===== 黑暗妖精武器：鋼爪（雙手，連擊） =====
        "wpn_claw_bronze":   { n: "青銅鋼爪", type: "wpn", w2h: true, dmgS: 8,  dmgL: 7,  hit: 2, spd: 0.9, req: "dark", safe: 6, p: 250,   eff: "combo", gachaWeight: 100, sizeMechanics: { small: { effect: "break_stance", defense: 1, durationTicks: 30 }, large: { effect: "stagger", delayTicks: 4, cooldownTicks: 40 } } },
        ...
        "wpn_claw_abyss":    { n: "暗黑鋼爪", type: "wpn", w2h: true, dmgS: 22, dmgL: 18, hit: 4, dmgBonus: 5, spd: 0.9, req: "dark", safe: 6, p: 10000, eff: "combo", gachaWeight: 5, prototypePolicy: { family: "鋼爪", small: { mode: "enhance", changes: { defense: 2, durationTicks: 30 } }, large: { mode: "sacrifice" } }, d: "深淵黑鐵打造的鋼爪。強化小型撕甲、犧牲大型牽扯；鋼爪雙擊維持不變。" },
        // ===== 魔獸軍王巴蘭卡：雙爪（鋼爪類，連擊） =====
        ...
        "wpn_baranka_steelclaw": { n: "巴蘭卡鋼爪",   type: "wpn", w2h: true, dmgS: 18, dmgL: 18, hit: 0, dmgBonus: 8, spd: 0.7, req: "dark", safe: 6, p: 125000, eff: "combo", legend: true, gachaWeight: 1, prototypePolicy: { family: "鋼爪", small: { mode: "sacrifice" }, large: { mode: "keep" } }, d: "巴蘭卡持用的沉重鋼爪。犧牲小型撕甲、保留大型牽扯，雙擊維持原有判定。" },
        // ===== 傳說單手劍：附帶魔法施放特效（spellProc，不需學會技能、必中、受魔法傷害影響） =====
        "wpn_dk_flameblade": { n: "死亡騎士的烈炎之劍", type: "wpn", dmgS: 16, dmgL: 10, hit: 5, dmgBonus: 2, spd: 0.8, req: "knight", safe: 6, p: 152000, legend: true, gachaWeight: 1, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, spellProc: { skn: "地獄火", dice: [16, 5], flat: 40, ele: "fire", aoe: true }, procRateBase: 3, procRatePerEn: 1, grantSkills: ["sk_nameless_king_flame"], grantSkillsEquipOnly: true, d: "焦黑劍鍔仍殘留古亞丁王冠的固定孔。犧牲小型橫掃、保留大型震盪；裝備後可使用無名王焰：32 秒內火抗 +15，地獄火發動率額外 +5%。" },
        "wpn_kurt_sword":    { n: "克特之劍", type: "wpn", dmgS: 15, dmgL: 11, hit: 9, dmgBonus: 5, spd: 0.8, req: "knight,elf", safe: 6, p: 152000, legend: true, gachaWeight: 1, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 30 } } }, spellProc: { skn: "極道落雷", dice: [5, 8], flat: 40, ele: "wind" }, procRateBase: 15, procRatePerEn: 1, d: "克特之劍，劍鋒遊走雷霆。犧牲小型橫掃、強化大型震盪；與克特之盾同時裝備後可使用雷霆敕令：32 秒內風抗 +15，審判落雷固定傷害再 +60。" },
        // ===== ⚡ 元素施放傳說武器（spellProc·攻擊1%+每強化1%觸發·必中·受魔法傷害影響·不吃法師階級加成） =====
        "wpn_thor_hammer":   { n: "雷神之鎚", type: "wpn", dmgS: 7, dmgL: 12, hit: 3, dmgBonus: 0, spd: 0.9, req: "royal,knight,elf,mage,warrior", safe: 6, p: 46000, legend: true, gachaWeight: 1, prototypePolicy: { family: "單手鈍器", small: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 30 } }, large: { mode: "sacrifice" } }, ignHardSkin: true, spellProc: { skn: "電光衝擊", dice: [5, 5], flat: 5, ele: "wind", status: { kind: "stun", pct: 5, dur: 3 } }, procRateBase: 1, procRatePerEn: 1, d: "雷神遺落的戰鎚。強化小型震盪、犧牲大型破勢；電光衝擊有 5% 機率使目標暈眩 3 秒。" },
        "wpn_pagrio_wrath":  { n: "帕格里奧之怒", type: "wpn", dmgS: 13, dmgL: 9, hit: 2, dmgBonus: 2, spd: 0.8, req: "royal,knight,elf", safe: 6, p: 56000, legend: true, gachaWeight: 1, prototypePolicy: { family: "單手劍", small: { mode: "enhance", changes: { every: 4, splashPct: 50, maxTargets: 1 } }, large: { mode: "sacrifice" } }, ignHardSkin: true, spellProc: { skn: "火焰之陣", dice: [6, 6], flat: 6, ele: "fire", aoe: true }, procRateBase: 1, procRatePerEn: 1, d: "帕格里奧之怒，劍身灼燒著永不熄滅的怒火。強化小型烈焰橫掃、犧牲大型震盪，攻擊可觸發火焰之陣。" },
        "wpn_mapler_punish": { n: "馬普勒的懲罰", type: "wpn", w2h: true, dmgS: 14, dmgL: 15, hit: 0, dmgBonus: 11, spd: 1, req: "royal,knight,elf,warrior", safe: 6, p: 46000, legend: true, gachaWeight: 1, eff: "crush", prototypePolicy: { family: "雙手鈍器", small: { mode: "replace", mechanic: { effect: "sweep", every: 3, splashPct: 45, maxTargets: 2 } }, large: { mode: "keep" } }, ignHardSkin: true, spellProc: { skn: "震裂術", dice: [6, 11], ele: "earth", aoe: true }, procRateBase: 1, procRatePerEn: 1, d: "馬普勒降下的懲戒之鎚。將對小型敵人的震盪替換為大地橫掃，保留大型破勢；攻擊可觸發全體震裂術。" },
        "wpn_osis_hammer":   { n: "歐西斯衝撞錘", type: "wpn", dmgS: 8, dmgL: 9, hit: 3, dmgBonus: 0, spd: 0.9, req: "royal,knight,warrior", safe: 6, p: 66000, legend: true, gachaWeight: 1, prototypePolicy: { family: "單手鈍器", small: { mode: "replace", mechanic: { effect: "sweep", every: 4, splashPct: 40, maxTargets: 1 } }, large: { mode: "keep" } }, ignHardSkin: true, spellProc: { skn: "流星雨", dice: [10, 11], ele: "fire", aoe: true }, procRateBase: 1, procRatePerEn: 1, d: "歐西斯鍛造的衝撞錘。將小型震盪替換為低頻橫掃，保留大型破勢；揮動時可觸發火屬性流星雨。" },
        "wpn_eva_scold":     { n: "伊娃的責罵", type: "wpn", dmgS: 9, dmgL: 9, hit: 1, dmgBonus: 1, spd: 0.8, req: "royal,knight,elf,mage,dark,dragon,illusion", safe: 6, p: 56400, legend: true, gachaWeight: 1, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 30 } } }, ignHardSkin: true, spellProc: { skn: "水之矛", dice: [5, 5], flat: 5, ele: "water", status: { kind: "freeze", pct: 5, dur: 4 } }, procRateBase: 1, procRatePerEn: 1, d: "伊娃的責罵，劍鋒凝著沁骨寒泉。犧牲小型橫掃、強化大型震盪；水之矛有 5% 機率冰凍 4 秒。" },
        // ===== 軍王之室：掉落裝備 =====
        ...
        "wpn_laia_wand":     { n: "蕾雅魔杖", type: "wpn", dmgS: 1, dmgL: 1, hit: -3, dmgBonus: 0, mdmg: -2, spd: 1.0, req: "mage", safe: 6, p: 23340, legend: true, gachaWeight: 1, prototypePolicy: { family: "魔杖", small: { mode: "enhance", changes: { durationTicks: 15, cooldownTicks: 40 } }, large: { mode: "sacrifice" } }, meleeHitSpell: { skn: "冰裂術", dice: [6, 10], ele: "water", freezePbase: 200, shatter: 100 }, d: "杖柄嵌著亞丁王室舊勳章。強化小型施法干擾、犧牲大型震盪；冰裂術與失名寒勳維持不變。" },
        ...
        "wpn_icequeen_wand": { n: "冰之女王魔杖", type: "wpn", dmgS: 3, dmgL: 4, hit: 5, dmgBonus: 1, spd: 1.0, req: "mage", safe: 6, p: 143340, legend: true, gachaWeight: 1, prototypePolicy: { family: "魔杖", small: { mode: "enhance", changes: { durationTicks: 15, cooldownTicks: 40 } }, large: { mode: "sacrifice" } }, procSkill: "sk_ice_spike", procRateBase: 8, procRatePerEn: 2, d: "冰之女王御用的魔杖。強化小型施法干擾、犧牲大型震盪，寒冰尖刺觸發維持不變。" },
        "wpn_demon_scythe":  { n: "惡魔鐮刀", type: "wpn", dmgS: 1, dmgL: 1, hit: 0, dmgBonus: 0, mdmg: 5, spd: 1.0, req: "mage", safe: 6, p: 173340, legend: true, gachaWeight: 1, isWand: true, prototypePolicy: { family: "魔杖", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "惡魔之力凝成的單手魔法鐮刀。保留小型施法干擾、犧牲大型震盪；魔法傷害與共鳴維持不變。" },   // 🔮 單手魔杖（共鳴·見 WAND_LIGHTARROW_IDS）；isWand→魔劍精通排除、不轉奇古獸
        ...
        // ===== 黑暗妖精武器：雙刀（雙手，連擊） =====
        "wpn_dual_bronze":   { n: "青銅雙刀", type: "wpn", w2h: true, dmgS: 8,  dmgL: 6,  hit: 3, spd: 0.8, req: "dark", safe: 6, p: 960,   eff: "combo", gachaWeight: 100, sizeMechanics: { small: { effect: "stagger", delayTicks: 3, cooldownTicks: 40 }, large: { effect: "break_stance", defense: 1, durationTicks: 40 } } },
        ...
        "wpn_dual_abyss":    { n: "暗黑雙刀", type: "wpn", w2h: true, dmgS: 18, dmgL: 14, hit: 4, dmgBonus: 3, spd: 0.8, req: "dark", safe: 6, p: 80000, eff: "combo", gachaWeight: 5, prototypePolicy: { family: "雙刀", small: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 40 } }, large: { mode: "sacrifice" } }, d: "深淵暗影淬成的雙刀。強化小型壓制、犧牲大型破勢；雙刀連擊維持不變。" },
        // ===== 🏛️ 底比斯·歐西里斯武器（攻擊時 4% 發動「惡魔之吻」：3D20 地屬性魔法傷害，受魔法傷害公式影響；玩家＋傭兵皆觸發） =====
        "wpn_thebes_bow":     { n: "底比斯歐西里斯弓", legend: true, type: "wpn", isBow: true, ranged: true, rapidfire: 80, dmgS: 3, dmgL: 3, hit: 0, dmgBonus: 1, int: 2, wis: 1, spd: 0.9, req: "elf,illusion", safe: 6, p: 235000, gachaWeight: 1, prototypePolicy: { family: "弓", small: { mode: "sacrifice" }, large: { mode: "keep" } }, procSkill: "sk_demon_kiss", procRateBase: 4, procRatePerEn: 0, d: "底比斯亡靈守護者持用的長弓。犧牲小型牽制、保留大型破勢，弓弦仍會低語歐西里斯的審判。" },
        "wpn_thebes_dual":    { n: "底比斯歐西里斯雙刀", legend: true, type: "wpn", w2h: true, dmgS: 16, dmgL: 11, hit: 0, dmgBonus: 1, dex: 2, wis: 1, spd: 0.7, req: "dark", safe: 6, p: 215000, eff: "combo", comboRate: 30, gachaWeight: 1, prototypePolicy: { family: "雙刀", small: { mode: "sacrifice" }, large: { mode: "keep" } }, procSkill: "sk_demon_kiss", procRateBase: 4, procRatePerEn: 0, d: "自底比斯神殿出土的雙刃。犧牲小型壓制、保留大型交叉破勢；雙擊與惡魔之吻維持不變。" },
        "wpn_thebes_2hsword": { n: "底比斯歐西里斯雙手劍", legend: true, type: "wpn", w2h: true, dmgS: 21, dmgL: 26, hit: 5, dmgBonus: 0, str: 1, con: 2, spd: 0.9, req: "knight,dragon", safe: 6, p: 255000, eff: "cleave", gachaWeight: 1, procSkill: "sk_demon_kiss", procRateBase: 4, procRatePerEn: 0, prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, d: "沉睡於歐西里斯祭壇的巨劍。犧牲小型橫掃、保留大型震盪；切割與惡魔之吻維持不變。" },
        "wpn_thebes_wand":    { n: "底比斯歐西里斯魔杖", legend: true, type: "wpn", w2h: true, dmgS: 20, dmgL: 18, hit: 2, dmgBonus: 3, str: 2, mdmg: 2, mpR: 7, spd: 0.9, req: "mage,illusion", safe: 6, p: 185000, eff: "magicstrike", gachaWeight: 1, procSkill: "sk_demon_kiss", procRateBase: 4, procRatePerEn: 0, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "keep" } }, d: "底比斯祭司執掌的魔杖。犧牲小型施法干擾、保留大型震盪；魔擊、惡魔之吻、屬性與回魔維持不變。" },
        ...
        "acc_stone_of_jordan": { n: "喬丹之石", legend: true, unique: true, noEnhance: true, noAffix: true, noJunk: true, type: "acc", slot: "ring", ac: 0, int: 1, mmp: 30, mmpPct: 15, mpR: 2, mdmg: 3, req: "all", safe: 0, p: 1000000, gachaWeight: 0, img: "assets/icons/accessories/底比斯賀洛斯戒指.png", d: "一枚蘊藏無盡魔力的傳說戒指。其力量只認可一位佩戴者，不接受強化或任何隨機詞綴。" },
        // ===== 🔥 v3.9.3 地獄火炬（獨立大型護符欄·八職業版本） =====
        "mat_key_terror": { n: "恐懼之鑰", type: "etc", noUse: true, noJunk: true, p: 50000, gachaWeight: 0, img: "assets/icons/items/墮落鑰匙.png", d: "吉爾塔斯守護的異界鑰匙。與憎恨之鑰、毀滅之鑰一同交給象牙塔的神秘魔法師，可製作未鑑定的地獄火炬。" },
        "mat_key_hatred": { n: "憎恨之鑰", type: "etc", noUse: true, noJunk: true, p: 50000, gachaWeight: 0, img: "assets/icons/items/混沌鑰匙.png", d: "安塔瑞斯守護的異界鑰匙。與恐懼之鑰、毀滅之鑰一同交給象牙塔的神秘魔法師，可製作未鑑定的地獄火炬。" },
        "mat_key_destruction": { n: "毀滅之鑰", type: "etc", noUse: true, noJunk: true, p: 50000, gachaWeight: 0, img: "assets/icons/items/骷髏鑰匙.png", d: "巴拉卡斯守護的異界鑰匙。與恐懼之鑰、憎恨之鑰一同交給象牙塔的神秘魔法師，可製作未鑑定的地獄火炬。" },
        "item_hellfire_torch_unidentified": { n: "未鑑定的地獄火炬", legend: true, type: "etc", eff: "hellfire_unseal", noJunk: true, p: 250000, gachaWeight: 0, img: "assets/icons/items/炎魔之心.png", d: "第一次由角色鑑定時必定成為本職地獄火炬；同一角色之後鑑定則從八職業版本中隨機出現。鑑定結果由存檔序號固定，無法以讀檔重抽。" },
        "charm_hellfire_royal":    { n: "地獄火炬（王族）",     legend: true, unique: true, noEnhance: true, noAffix: true, noJunk: true, type: "acc", slot: "charm", req: "royal",    reqLv: 70, str: 2, dex: 2, con: 2, int: 2, wis: 2, cha: 2, resFire: 10, resWater: 10, resEarth: 10, resWind: 10, classSkillMult: 1.10, hellfireProc: { rate: 5, cdSec: 10 }, p: 1000000, gachaWeight: 0, img: "assets/icons/items/炎魔之心.png", d: "大型護符。強化王族原本技能，但不授予任何新技能；攻擊命中時可引發帶有內置冷卻的地獄火焰。" },
        "charm_hellfire_knight":   { n: "地獄火炬（騎士）",     legend: true, unique: true, noEnhance: true, noAffix: true, noJunk: true, type: "acc", slot: "charm", req: "knight",   reqLv: 70, str: 2, dex: 2, con: 2, int: 2, wis: 2, cha: 2, resFire: 10, resWater: 10, resEarth: 10, resWind: 10, classSkillMult: 1.10, hellfireProc: { rate: 5, cdSec: 10 }, p: 1000000, gachaWeight: 0, img: "assets/icons/items/炎魔之心.png", d: "大型護符。強化騎士原本技能，但不授予任何新技能；攻擊命中時可引發帶有內置冷卻的地獄火焰。" },
        "charm_hellfire_mage":     { n: "地獄火炬（法師）",     legend: true, unique: true, noEnhance: true, noAffix: true, noJunk: true, type: "acc", slot: "charm", req: "mage",     reqLv: 70, str: 2, dex: 2, con: 2, int: 2, wis: 2, cha: 2, resFire: 10, resWater: 10, resEarth: 10, resWind: 10, classSkillMult: 1.10, hellfireProc: { rate: 5, cdSec: 10 }, p: 1000000, gachaWeight: 0, img: "assets/icons/items/炎魔之心.png", d: "大型護符。強化法師原本技能，但不授予任何新技能；不會把九頭蛇變成獨立技能，攻擊命中時僅引發帶有內置冷卻的地獄火焰。" },
        "charm_hellfire_elf":      { n: "地獄火炬（妖精）",     legend: true, unique: true, noEnhance: true, noAffix: true, noJunk: true, type: "acc", slot: "charm", req: "elf",      reqLv: 70, str: 2, dex: 2, con: 2, int: 2, wis: 2, cha: 2, resFire: 10, resWater: 10, resEarth: 10, resWind: 10, classSkillMult: 1.10, hellfireProc: { rate: 5, cdSec: 10 }, p: 1000000, gachaWeight: 0, img: "assets/icons/items/炎魔之心.png", d: "大型護符。強化妖精原本技能，但不授予任何新技能；攻擊命中時可引發帶有內置冷卻的地獄火焰。" },
        "charm_hellfire_dark":     { n: "地獄火炬（黑暗妖精）", legend: true, unique: true, noEnhance: true, noAffix: true, noJunk: true, type: "acc", slot: "charm", req: "dark",     reqLv: 70, str: 2, dex: 2, con: 2, int: 2, wis: 2, cha: 2, resFire: 10, resWater: 10, resEarth: 10, resWind: 10, classSkillMult: 1.10, hellfireProc: { rate: 5, cdSec: 10 }, p: 1000000, gachaWeight: 0, img: "assets/icons/items/炎魔之心.png", d: "大型護符。強化黑暗妖精原本技能，但不授予任何新技能；攻擊命中時可引發帶有內置冷卻的地獄火焰。" },
        "charm_hellfire_illusion": { n: "地獄火炬（幻術士）",   legend: true, unique: true, noEnhance: true, noAffix: true, noJunk: true, type: "acc", slot: "charm", req: "illusion", reqLv: 70, str: 2, dex: 2, con: 2, int: 2, wis: 2, cha: 2, resFire: 10, resWater: 10, resEarth: 10, resWind: 10, classSkillMult: 1.10, hellfireProc: { rate: 5, cdSec: 10 }, p: 1000000, gachaWeight: 0, img: "assets/icons/items/炎魔之心.png", d: "大型護符。強化幻術士原本技能與召喚傷害，但不授予任何新技能；攻擊命中時可引發帶有內置冷卻的地獄火焰。" },
        "charm_hellfire_dragon":   { n: "地獄火炬（龍騎士）",   legend: true, unique: true, noEnhance: true, noAffix: true, noJunk: true, type: "acc", slot: "charm", req: "dragon",   reqLv: 70, str: 2, dex: 2, con: 2, int: 2, wis: 2, cha: 2, resFire: 10, resWater: 10, resEarth: 10, resWind: 10, classSkillMult: 1.10, hellfireProc: { rate: 5, cdSec: 10 }, p: 1000000, gachaWeight: 0, img: "assets/icons/items/炎魔之心.png", d: "大型護符。強化龍騎士原本技能，但不授予任何新技能；攻擊命中時可引發帶有內置冷卻的地獄火焰。" },
        "charm_hellfire_warrior":  { n: "地獄火炬（戰士）",     legend: true, unique: true, noEnhance: true, noAffix: true, noJunk: true, type: "acc", slot: "charm", req: "warrior",  reqLv: 70, str: 2, dex: 2, con: 2, int: 2, wis: 2, cha: 2, resFire: 10, resWater: 10, resEarth: 10, resWind: 10, classSkillMult: 1.10, hellfireProc: { rate: 5, cdSec: 10 }, p: 1000000, gachaWeight: 0, img: "assets/icons/items/炎魔之心.png", d: "大型護符。強化戰士原本技能，但不授予任何新技能；攻擊命中時可引發帶有內置冷卻的地獄火焰。" },
        ...
        "wpn_xbow_abyss": { n: "暗黑十字弓", type: "wpn", isBow: true, ranged: true, rapidfire: 70, w2h: true, dmgS: 5, dmgL: 5, hit: 4, dmgBonus: 6, spd: 1.0, req: "elf,dark", safe: 6, p: 180000, gachaWeight: 1, ignHardSkin: true, prototypePolicy: { family: "十字弓", small: { mode: "enhance", changes: { defense: 2, durationTicks: 30 } }, large: { mode: "sacrifice" } }, d: "以深淵暗黑之力凝成的十字弓。強化小型穿甲破勢、犧牲大型震盪；箭矢仍可無視硬皮額外減傷。" },
        // ===== 魔力短劍（匕首，全職業） =====
        "wpn_manadagger": { n: "魔力短劍", type: "wpn", dmgS: 6, dmgL: 4, hit: 0, dmgBonus: 1, spd: 0.6, req: "all", safe: 6, p: 191000, eff: "mp_drain", unBonus: true, str: 1, mpR: 1, legend: true, gachaWeight: 1, prototypePolicy: { family: "匕首", small: { mode: "sacrifice" }, large: { mode: "keep" } }, d: "刃中封藏著流動魔力的短劍。犧牲小型貫穿、保留大型破勢；命中回魔、不死加成與自然回魔維持不變。" },   // 🔧 傳說武器：琥珀金名稱＋專屬藍色圖示光芒
        // ===== 拉斯塔巴德地下洞穴：掉落武器 =====
        ...
        "wpn_darkmage_wand": { n: "黑法師之杖", type: "wpn", dmgS: 1, dmgL: 1, hit: 0, dmgBonus: 0, mdmg: 2, mpR: 5, spd: 1.0, req: "mage", safe: 6, p: 94510, gachaWeight: 5, prototypePolicy: { family: "魔杖", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "黑法師以暗術雕成的魔杖。保留小型施法干擾、犧牲大型震盪；魔法傷害、回魔與共鳴維持不變。" },   // 共鳴（見 WAND_LIGHTARROW_IDS）
        ...
        "wpn_emperor_blade":   { n: "真．冥皇執行劍", type: "wpn", w2h: true, legend: true, dmgS: 28, dmgL: 33, hit: 5, dmgBonus: 20, spd: 1, req: "knight,dragon", safe: 0, p: 500000, gachaWeight: 0, eff: "cleave", ignHardSkin: true, str: 2, dex: 1, stunHitBonus: 20, prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 6, cooldownTicks: 30 } } }, d: "冥皇執行劍的真實之姿。犧牲小型橫掃、強化大型震盪；切割、貫穿與暈眩命中加成維持不變。" },
        "wpn_windblade_dagger":{ n: "風刃短劍", type: "wpn", legend: true, dmgS: 23, dmgL: 16, hit: 10, dmgBonus: 10, spd: 0.6, req: "knight,elf,mage,royal,dark", safe: 0, p: 500000, gachaWeight: 0, prototypePolicy: { family: "匕首", small: { mode: "keep" }, large: { mode: "sacrifice" } }, ignHardSkin: true, mhp: 100, dex: 2, vampPct: 0.1, d: "風之精靈寄宿的短劍。保留對小型敵人的低量貫穿、犧牲大型破勢；生命 +100、敏捷 +2，並吸取傷害的 10% HP。" },
        "wpn_redshadow_dual":  { n: "紅影雙刀", type: "wpn", w2h: true, legend: true, dmgS: 27, dmgL: 18, hit: 10, dmgBonus: 18, spd: 0.8, req: "dark", safe: 0, p: 500000, gachaWeight: 0, eff: "combo", comboRate: 35, ignHardSkin: true, dex: 2, wis: 2, prototypePolicy: { family: "雙刀", small: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 40 } }, large: { mode: "sacrifice" } }, procStatusSkill: { skId: "sk_slow", rate: 10 }, d: "殷紅殘影交織的雙刀。強化小型壓制、犧牲大型破勢；35%雙擊與緩速維持不變。" },
        "wpn_beastking_claw":  { n: "獸王鋼爪", type: "wpn", w2h: true, legend: true, dmgS: 25, dmgL: 20, hit: 15, dmgBonus: 10, spd: 0.9, req: "dark", safe: 0, p: 500000, gachaWeight: 0, eff: "combo", comboRate: 33, ignHardSkin: true, str: 2, dex: 2, prototypePolicy: { family: "鋼爪", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 5, cooldownTicks: 40 } } }, d: "獸王之力灌注的鋼爪。犧牲小型撕甲、強化大型牽扯；33%雙擊與屬性加成維持不變。" },
        "wpn_rond_dual":       { n: "倫得雙刀", type: "wpn", w2h: true, dmgS: 18, dmgL: 8, hit: 7, dmgBonus: 2, spd: 0.8, req: "dark", safe: 6, p: 56000, gachaWeight: 5, eff: "combo", comboRate: 33, ignHardSkin: true, prototypePolicy: { family: "雙刀", small: { mode: "sacrifice" }, large: { mode: "keep" } }, procSkill: "sk_revenge_spike", procRateBase: 5, procRatePerEn: 1, d: "倫得一族代代相傳的雙刃。犧牲小型壓制、保留大型交叉破勢；雙擊與復仇尖石維持不變。" },   // 🗡️ 雙擊33/貫穿/復仇尖石 5%＋每強化+1%（+20→25%·WEAPON_TAGS 雙刀 於 js/10·重量與掉落於 js/01）
        "wpn_holycrystal_wand":{ n: "聖晶魔杖", type: "wpn", w2h: true, legend: true, dmgS: 13, dmgL: 15, hit: 8, dmgBonus: 0, spd: 1.0, req: "mage,illusion", safe: 0, p: 500000, gachaWeight: 0, eff: "magicburst", ignHardSkin: true, int: 2, mdmg: 8, mmp: 50, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 3, cooldownTicks: 40 } } }, procSkill: "sk_holy_lightning", procRateBase: 10, procRatePerEn: 1, d: "聖潔水晶鑲嵌的雙手魔杖。犧牲小型施法干擾、強化大型震盪；魔爆與致命落雷維持不變。" },
        ...
        "relic_goblin_blade":      { n: "哥布林的石刃",       type: "wpn", relic: true, noEnhance: true, dmgS: 4, dmgL: 6, hit: 4, dmgBonus: 3, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,mage,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】哥布林用石片磨成的粗劣短刃。犧牲小型橫掃、保留大型震盪。" },
        "relic_orcarcher_bow":     { n: "妖魔弓箭手的彈簧弓", type: "wpn", isBow: true, ranged: true, relic: true, noEnhance: true, ignHardSkin: true, rapidfire: 50, dmgS: 2, dmgL: 2, hit: 4, dmgBonus: 3, prototypePolicy: { family: "弓", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 30 } } }, req: "royal,knight,elf,mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】妖魔弓箭手臨時綁製的彈簧弓。犧牲小型牽制、強化大型破勢，射出的箭仍能無視硬皮額外減傷。" },
        "relic_gremlin_club":      { n: "地靈的木棍",         type: "wpn", relic: true, noEnhance: true, dmgS: 6, dmgL: 3, hit: 2, dmgBonus: 2, procStatusSkill: { skId: "sk_relic_stun", rate: 1 }, prototypePolicy: { family: "單手鈍器", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,mage,illusion,dragon,warrior", p: 10000, gachaWeight: 0, d: "【遺物】地靈揮舞的粗木棍。犧牲小型震盪、保留大型破勢，避免與原有暈眩重複控制。" },
        ...
        "relic_husky_bone":        { n: "哈士奇的骨棒",       type: "wpn", relic: true, noEnhance: true, dmgS: 6, dmgL: 3, hit: 6, dmgBonus: 6, partnerHit: { "哈士奇": 6 }, prototypePolicy: { family: "單手鈍器", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "royal,knight,elf,mage,illusion,dragon,warrior", p: 10000, gachaWeight: 0, d: "【遺物】哈士奇最愛叼著跑的骨棒。保留小型震盪、犧牲大型破勢；哈士奇命中加成維持不變。" },
        ...
        "relic_zombie_shin":       { n: "殭屍的小腿骨",       type: "wpn", isWand: true, relic: true, noEnhance: true, dmgS: 3, dmgL: 4, hit: 3, dmgBonus: 3, extraMp: 7, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】殭屍殘留魔力的小腿骨。犧牲小型施法干擾、保留大型震盪；額外 MP 維持不變。" },
        "relic_doberman_fang":     { n: "杜賓的尖銳犬齒",     type: "wpn", relic: true, noEnhance: true, dmgS: 4, dmgL: 2, hit: 11, dmgBonus: 9, prototypePolicy: { family: "匕首", small: { mode: "enhance", changes: { chance: 20, splashPct: 30 } }, large: { mode: "sacrifice" } }, req: "royal,knight,elf,mage,dark", p: 10000, gachaWeight: 0, d: "【遺物】杜賓狗銳利的犬齒。強化小型貫穿機率、犧牲大型破勢，維持快速且低波及的攻擊方式。" },
        "relic_amp_staff":          { n: "安普長老的拐杖",     type: "wpn", isWand: true, relic: true, noEnhance: true, dmgS: 3, dmgL: 4, hit: 5, dmgBonus: 5, extraMp: 9, procSkill: "sk_hell_fang", procRateBase: 15, procRatePerEn: 0, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】安普長老生前倚仗的拐杖。犧牲小型施法干擾、保留大型震盪；地獄犬之牙與 MP 維持不變。" },
        ...
        "relic_gladiator_scimitar": { n: "鬥士的歷戰彎刀",     type: "wpn", relic: true, noEnhance: true, dmgS: 8, dmgL: 8, hit: 9, dmgBonus: 9, prototypePolicy: { family: "單手劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "royal,knight,elf,mage,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】妖魔鬥士的歷戰彎刀。保留小型橫掃、犧牲大型震盪。" },
        "relic_icefield_pick":      { n: "冰原十字鎬",         type: "wpn", relic: true, noEnhance: true, dmgS: 6, dmgL: 4, hit: 5, dmgBonus: 5, procStatusSkill: { skId: "sk_relic_freeze", rate: 1 }, prototypePolicy: { family: "單手鈍器", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,mage,illusion,dragon,warrior", p: 10000, gachaWeight: 0, d: "【遺物】冰原狼人用來鑿冰的十字鎬。犧牲小型震盪、保留大型破勢；刺骨冰凍維持不變。" },
        ...
        "relic_werewolf_mace":      { n: "狼人的釘錘",         type: "wpn", relic: true, noEnhance: true, dmgS: 6, dmgL: 8, hit: 6, dmgBonus: 6, str: 1, prototypePolicy: { family: "單手鈍器", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 40 } } }, req: "royal,knight,elf,mage,illusion,dragon,warrior", p: 10000, gachaWeight: 0, d: "【遺物】狼人揮舞的粗製釘錘。犧牲小型震盪、強化大型破勢；野性力量加成維持不變。" },
        ...
        "relic_orc_nail":           { n: "惡臭的妖魔指甲",     type: "wpn", relic: true, noEnhance: true, dmgS: 2, dmgL: 3, hit: 9, dmgBonus: 7, procPoison: { rate: 30, dmg: [10, 1], dur: 10, tick: 1 }, prototypePolicy: { family: "匕首", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,mage,dark", p: 10000, gachaWeight: 0, d: "【遺物】妖魔殭屍剝落的惡臭指甲。犧牲小型貫穿、保留大型破勢；傷口潰爛的劇毒維持不變。" },
        ...
        "relic_pan_staff":          { n: "牧神的放牧棍",       type: "wpn", relic: true, noEnhance: true, dmgS: 6, dmgL: 8, hit: 6, dmgBonus: 6, prototypePolicy: { family: "單手矛", small: { mode: "sacrifice" }, large: { mode: "keep" } }, petDmgAll: 3, req: "royal,knight,elf,mage,warrior", p: 10000, gachaWeight: 0, d: "【遺物】污染之潘驅趕牲口的長棍。犧牲小型貫穿、保留大型破勢；所有寵物傷害 +3。" },
        ...
        "relic_giantant_antenna":   { n: "巨蟻的誘導觸角",     type: "wpn", isBow: true, ranged: true, relic: true, noEnhance: true, rapidfire: 100, dmgS: 2, dmgL: 2, hit: 11, dmgBonus: 6, prototypePolicy: { family: "弓", small: { mode: "enhance", changes: { delayTicks: 3, cooldownTicks: 30 } }, large: { mode: "sacrifice" } }, req: "royal,knight,elf,mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】巨蟻的誘導觸角改製而成的長弓。強化小型牽制、犧牲大型破勢，能引導箭矢精準追住靈巧獵物。" },
        ...
        "relic_elastic_rib":        { n: "有彈性的肋骨",       type: "wpn", w2h: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 8, dmgL: 8, hit: 6, dmgBonus: 9, dr: 2, eff: "combo", comboRate: 30, prototypePolicy: { family: "雙刀", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】柔韌肋骨製成的雙刃。保留小型壓制、犧牲大型破勢，傷害減免與雙擊維持不變。" },
        ...
        "relic_golem_fist":         { n: "石頭高崙的重拳",     type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 17, dmgL: 19, hit: 7, dmgBonus: 7, eff: "crush", prototypePolicy: { family: "雙手鈍器", small: { mode: "keep" }, large: { mode: "sacrifice" } }, procSkill: "sk_quake", procRateBase: 5, procRatePerEn: 0, req: "royal,knight,elf,illusion,dragon,warrior", p: 10000, gachaWeight: 0, d: "【遺物】石頭高崙揮出的沉重巨拳。保留對小型敵人的震盪、犧牲大型破勢；攻擊時 5% 觸發地震術。" },
        "relic_orc_cleaver":        { n: "妖魔的老舊菜刀",     type: "wpn", relic: true, noEnhance: true, dmgS: 8, dmgL: 8, hit: 6, dmgBonus: 6, ele: "earth", prototypePolicy: { family: "單手劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "royal,knight,elf,mage,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】妖魔廚房裡鏽蝕的老菜刀。保留小型橫掃、犧牲大型震盪；大地屬性維持不變。" },
        "relic_strong_femur":       { n: "強韌的大腿骨",       type: "wpn", relic: true, noEnhance: true, dmgS: 6, dmgL: 3, hit: 4, dmgBonus: 4, procInstakill: { p: 0.20, tag: "undead", maxLv: 49 }, prototypePolicy: { family: "單手鈍器", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "royal,knight,elf,mage,illusion,dragon,warrior", p: 10000, gachaWeight: 0, d: "【遺物】異常強韌的大腿骨。保留小型震盪、犧牲大型破勢；對低階不死生物的即死效果維持不變。" },
        "relic_forgotten_spear":    { n: "遺忘士兵的老舊長槍",  type: "wpn", w2h: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 10, dmgL: 12, hit: 7, dmgBonus: 7, eff: "pierce", pierceChance: 90, prototypePolicy: { family: "雙手矛", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "royal,elf", p: 10000, gachaWeight: 0, d: "【遺物】遺忘士兵生前緊握的長槍，仍保留對小型敵人的貫穿本能，卻已失去對大型敵人破勢的完整槍勢。" },
        "relic_spider_claw":        { n: "巨大蜘蛛的恐懼尖爪",  type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 17, dmgL: 15, hit: 10, dmgBonus: 9, eff: "combo", comboRate: 30, prototypePolicy: { family: "鋼爪", small: { mode: "enhance", changes: { defense: 2, durationTicks: 30 } }, large: { mode: "sacrifice" } }, procPoison: { rate: 50, dmg: [10, 1], dur: 10, tick: 1 }, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】巨大蜘蛛的恐懼尖爪。強化小型撕甲、犧牲大型牽扯；雙擊與劇毒維持不變。" },
        ...
        "relic_hobgoblin_grinder":  { n: "哈柏哥布林的研磨刀",  type: "wpn", relic: true, noEnhance: true, dmgS: 4, dmgL: 6, hit: 12, dmgBonus: 11, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 30 } } }, req: "royal,knight,elf,mage,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】哈柏哥布林反覆研磨的短刀。犧牲小型橫掃、強化大型震盪，展現削鐵鋒芒。" },
        "relic_orc_butcher":        { n: "妖魔的屠刀",         type: "wpn", relic: true, noEnhance: true, dmgS: 8, dmgL: 8, hit: 10, dmgBonus: 10, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,mage,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】阿吐巴妖魔的厚重屠刀。犧牲小型橫掃、保留大型震盪。" },
        "relic_orc_pole":           { n: "妖魔的曬衣桿",       type: "wpn", relic: true, noEnhance: true, dmgS: 4, dmgL: 6, hit: 9, dmgBonus: 9, prototypePolicy: { family: "單手矛", small: { mode: "keep" }, large: { mode: "sacrifice" } }, unBonus: true, req: "royal,knight,elf,mage,warrior", p: 10000, gachaWeight: 0, d: "【遺物】妖魔拿來曬衣的細長桿子。保留小型貫穿、犧牲大型破勢，並對不死生物與狼人造成額外傷害。" },
        ...
        "relic_sparta_grudge":      { n: "史巴托的怨念",       type: "wpn", w2h: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 11, dmgL: 7, hit: 11, dmgBonus: 10, eff: "combo", comboRate: 25, prototypePolicy: { family: "雙刀", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】史巴托怨念凝成的雙刀。保留小型壓制、犧牲大型破勢，維持快速雙擊特色。" },
        ...
        "relic_shark_teeth":        { n: "鯊魚的千刃牙",       type: "wpn", relic: true, noEnhance: true, dmgS: 4, dmgL: 3, hit: 9, dmgBonus: 7, unBonus: true, ele: "water", prototypePolicy: { family: "匕首", small: { mode: "enhance", changes: { chance: 20, splashPct: 30 } }, large: { mode: "sacrifice" } }, req: "royal,knight,elf,mage,dark", p: 10000, gachaWeight: 0, d: "【遺物】鯊魚層疊如刃的利牙。強化小型貫穿機率、犧牲大型破勢；水勢與不死加成維持不變。" },
        ...
        "relic_guard_spear":        { n: "鎧衛隊的漆黑長槍",   type: "wpn", relic: true, noEnhance: true, prototypePolicy: { family: "單手矛", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 40 } } }, ignHardSkin: true, dmgS: 6, dmgL: 8, hit: 12, dmgBonus: 12, req: "royal,knight,warrior", p: 10000, gachaWeight: 0, d: "【遺物】鎧衛隊配發的漆黑長槍。犧牲小型貫穿、強化大型破勢，並無視硬皮額外減傷。" },
        ...
        "relic_crab_claw":          { n: "蟹人的巨鉗",         type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 14, dmgL: 12, hit: -2, dmgBonus: 7, eff: "combo", comboRate: 33, mcrit: 5, ele: "water", prototypePolicy: { family: "鋼爪", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】蟹人的巨大甲鉗。保留小型撕甲、犧牲大型牽扯；雙擊、水屬性與爆擊維持不變。" },
        ...
        "relic_venom_fang":         { n: "劇毒的獠牙",         type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 17, dmgL: 21, hit: 9, dmgBonus: 12, eff: "cleave", procPoison: { rate: 50, dmg: [30, 1], dur: 10, tick: 1 }, prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】狂野毒牙淬鍊的巨牙。犧牲小型橫掃、保留大型震盪；奔流不止的劇毒維持不變。" },
        ...
        "relic_ratman_skewer":      { n: "鼠人的烤肉叉",       type: "wpn", w2h: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 16, dmgL: 16, hit: 11, dmgBonus: 8, eff: "pierce", pierceChance: 80, extraDmg: 10, unBonus: true, ele: "fire", prototypePolicy: { family: "雙手矛", small: { mode: "enhance", changes: { chance: 35, splashPct: 40, maxTargets: 1 } }, large: { mode: "sacrifice" } }, req: "royal,knight,elf,warrior", p: 10000, gachaWeight: 0, d: "【遺物】鼠人炙烤獵物的長叉。強化小型貫穿機率、犧牲大型破勢；火焰、不死加成與額外傷害維持不變。" },
        "relic_starfish_arm":       { n: "海星的分裂腕足",     type: "wpn", w2h: true, chainsword: true, weakExpose: true, relic: true, noEnhance: true, dmgS: 21, dmgL: 20, hit: 14, dmgBonus: 11, eff: "combo", comboRate: 20, procStatusSkill: { skId: "sk_relic_paralyze", rate: 1 }, str: 2, wis: 2, prototypePolicy: { family: "鎖鏈劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "dragon", p: 10000, gachaWeight: 0, d: "【遺物】海星再生不絕的分裂腕足。保留小型纏足、犧牲大型扯甲；弱點曝光、雙擊與麻痺維持不變。" },
        "relic_croc_soul":          { n: "被遺忘的鱷魚靈魂",   type: "wpn", qigu: true, relic: true, noEnhance: true, dmgS: 24, dmgL: 24, hit: 0, mdmg: 2, wis: 2, extraMp: 9, procSkill: "sk_icearrow", procRateBase: 15, procRatePerEn: 0, prototypePolicy: { family: "奇古獸", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "illusion", p: 10000, gachaWeight: 0, d: "【遺物】遺忘之島鱷魚殘留的靈魂。保留小型幻壓、犧牲大型回靈；必中魔法與冰箭維持不變。" },
        ...
        "relic_elder_thunder":      { n: "長老的雷電能量",     type: "wpn", isWand: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 4, dmgL: 5, hit: 4, dmgBonus: 4, extraMp: 3, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "keep" } }, procSkill: "sk_thunder", procRateBase: 100, procRatePerEn: 0, procOnHit: true, req: "mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】長老掌中凝聚的雷電能量。犧牲小型施法干擾、保留大型震盪；命中必定觸發極道落雷。" },
        ...
        "relic_mandra_spirit":      { n: "曼陀羅之靈",         type: "wpn", qigu: true, relic: true, noEnhance: true, dmgS: 26, dmgL: 26, hit: 0, mpR: 15, int: 1, extraMp: 7, procInstakill: { p: 0.01 }, prototypePolicy: { family: "奇古獸", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "illusion", p: 10000, gachaWeight: 0, d: "【遺物】底比斯曼陀羅草凝成的靈體。犧牲小型幻壓、保留大型回靈；必中魔法與即死判定維持不變。" },
        ...
        "relic_cerberus_wand":      { n: "三頭犬魔杖",         type: "wpn", isWand: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 2, dmgL: 3, hit: 9, dmgBonus: 9, mdmg: 3, extraMp: 5, ele: "fire", prototypePolicy: { family: "魔杖", small: { mode: "keep" }, large: { mode: "sacrifice" } }, spellProc: { skn: "噴火", dice: [4, 6], ele: "fire", aoe: true }, procRateBase: 10, procRatePerEn: 0, req: "mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】以地獄犬三首煉成的魔杖。保留小型施法干擾、犧牲大型震盪，業火噴吐維持原有判定。" },
        "relic_watersprite_string": { n: "水靈的琴弦",         type: "wpn", isBow: true, ranged: true, w2h: true, relic: true, noEnhance: true, ignHardSkin: true, rapidfire: 70, dmgS: 3, dmgL: 3, hit: 8, dmgBonus: 11, extraDmg: 5, ele: "water", prototypePolicy: { family: "弓", small: { mode: "keep" }, large: { mode: "sacrifice" } }, spellProc: { skn: "寒冰氣息", dice: [5, 5], flat: 5, ele: "water", aoe: true }, procRateBase: 5, procRatePerEn: 0, req: "elf,illusion", p: 10000, gachaWeight: 0, d: "【遺物】希爾黛斯撥動的水靈琴弦。保留小型牽制、犧牲大型破勢，箭矢仍可喚起寒冰氣息。" },
        ...
        "relic_lizardman_cleaver":  { n: "蜥蜴人的大砍刀",     type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 10, dmgL: 17, hit: 10, dmgBonus: 10, eff: "pierce", pierceChance: 50, vampPct: 0.03, mhp: 60, prototypePolicy: { family: "雙手矛", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,warrior", p: 10000, gachaWeight: 0, d: "【遺物】重裝蜥蜴人揮舞的大砍刀。犧牲小型貫穿、保留大型破勢；飲血與生命加成維持不變。" },
        // ===== 🏺 遺物 第三批（v3.1.2·19 件·單一怪物專屬掉落 0.0001%）=====
        "relic_ohm_maul":           { n: "歐姆裝甲兵的超重鎚", type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 20, dmgL: 26, hit: 7, dmgBonus: 11, eff: "crush", prototypePolicy: { family: "雙手鈍器", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 3, durationTicks: 50 } } }, mcrit: 3, mcritDmg: 10, req: "royal,knight,dragon,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】歐姆裝甲兵掄起的超重戰鎚。犧牲小型震盪，將大型破勢強化至原型上限；魔法爆擊率 +3%、魔法爆擊傷害 +10%。" },
        ...
        "relic_parrot_beak":        { n: "七彩鸚鵡喙",       type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 20, dmgL: 17, hit: 9, dmgBonus: 12, eff: "cleave", ele: "wind", procStatusSkill: { skId: "sk_relic_silence", rate: 1 }, prototypePolicy: { family: "雙手劍", small: { mode: "enhance", changes: { every: 3, splashPct: 54, maxTargets: 2 } }, large: { mode: "sacrifice" } }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】奇異鸚鵡巨大的七彩喙。強化小型橫掃波及、犧牲大型震盪；疾風與沉默觸發維持不變。" },
        "relic_pirate_scimitar":    { n: "海賊經典彎刀",     type: "wpn", relic: true, noEnhance: true, dmgS: 8, dmgL: 8, hit: 15, dmgBonus: 15, prototypePolicy: { family: "單手劍", small: { mode: "enhance", changes: { every: 4, splashPct: 50, maxTargets: 1 } }, large: { mode: "sacrifice" } }, req: "royal,knight,elf,mage,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】海賊骷髏至死緊握的彎刀。強化小型橫掃波及、犧牲大型震盪。" },
        "relic_scorpion_sting":     { n: "毒蠍的尾刺",       type: "wpn", relic: true, noEnhance: true, dmgS: 3, dmgL: 3, hit: 7, dmgBonus: 5, prototypePolicy: { family: "匕首", small: { mode: "keep" }, large: { mode: "sacrifice" } }, procPoison: { rate: 100, dmg: [30, 1], dur: 10, tick: 1 }, procInstakill: { p: 0.01 }, req: "royal,knight,elf,mage,dark", p: 10000, gachaWeight: 0, d: "【遺物】毒蠍淬滿劇毒的尾刺。保留小型貫穿、犧牲大型破勢；必定施毒，並有 1% 機率使非頭目立即死亡。" },
        "relic_harvey_claw":        { n: "哈維的吸血爪",     type: "wpn", relic: true, noEnhance: true, dmgS: 9, dmgL: 11, hit: 8, dmgBonus: 8, vampPct: 0.05, spellProc: { skn: "吸血鬼之吻", dice: [2, 10], flat: 10, ele: "none", heal: 1.0 }, procRateBase: 3, procRatePerEn: 0, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,mage,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】哈維鮮血淋漓的利爪。犧牲小型橫掃、保留大型震盪；吸血與吸血鬼之吻維持不變。" },
        ...
        "relic_apprentice_wand":    { n: "黑魔法學徒魔杖",   type: "wpn", isWand: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 1, dmgL: 1, hit: 6, dmgBonus: 6, extraMp: 6, mpR: 15, prototypePolicy: { family: "魔杖", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "mage", p: 10000, gachaWeight: 0, d: "【遺物】黑暗妖精學徒的入門魔杖。保留小型施法干擾、犧牲大型震盪；魔力恢復維持不變。" },
        ...
        "relic_sharpshooter_bow":   { n: "神射手的重弦弓",   type: "wpn", isBow: true, ranged: true, w2h: true, relic: true, noEnhance: true, ignHardSkin: true, rapidfire: 90, dmgS: 2, dmgL: 2, hit: 13, dmgBonus: 9, rcrit: 3, prototypePolicy: { family: "弓", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 30 } } }, req: "royal,knight,elf,dark,illusion", p: 10000, gachaWeight: 0, d: "【遺物】骷髏神射手的重弦長弓。犧牲小型牽制、強化大型破勢，將箭勢集中於甲胄弱點。" },
        "relic_guard_pike":         { n: "警衛的穿心矛",     type: "wpn", relic: true, noEnhance: true, dmgS: 7, dmgL: 8, hit: 9, dmgBonus: 9, prototypePolicy: { family: "單手矛", small: { mode: "sacrifice" }, large: { mode: "keep" } }, unBonus: true, mmp: 50, mpOnHit: true, req: "royal,knight,elf,mage,warrior", p: 10000, gachaWeight: 0, d: "【遺物】骷髏警衛的穿心矛。犧牲小型貫穿、保留大型破勢；MP +50，命中時恢復 MP，並剋制不死與狼人。" },
        "relic_whirlwind_xbow":     { n: "旋風十字弓",       type: "wpn", isBow: true, ranged: true, oneHand: true, relic: true, noEnhance: true, rapidfire: 70, dmgS: 3, dmgL: 3, hit: 13, dmgBonus: 10, mdmg: 2, ele: "wind", prototypePolicy: { family: "十字弓", small: { mode: "keep" }, large: { mode: "sacrifice" } }, procSkill: "sk_tornado", procRateBase: 3, procRatePerEn: 0, req: "elf,dark,illusion", p: 10000, gachaWeight: 0, d: "【遺物】黑暗精靈的旋風十字弓。保留小型穿甲破勢、犧牲大型震盪；單手持握與龍捲風觸發維持不變。" },
        ...
        "relic_ogi_greataxe":       { n: "歐吉的巨大戰斧",   type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 20, dmgL: 26, hit: 12, dmgBonus: 12, eff: "crush", str: 3, mhp: 50, prototypePolicy: { family: "雙手鈍器", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,illusion,dragon,warrior", p: 10000, gachaWeight: 0, d: "【遺物】歐吉揮舞的巨大戰斧。犧牲小型震盪、保留大型破勢；蠻力與生命加成維持不變。" },
        ...
        "relic_darkthief_claw":     { n: "黑暗盜賊的兇殺爪", type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 17, dmgL: 15, hit: 10, dmgBonus: 13, eff: "combo", comboRate: 50, extraDmg: 10, prototypePolicy: { family: "鋼爪", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】黑暗盜賊行兇的雙爪。保留小型撕甲、犧牲大型牽扯；50%雙擊與既有傷害加成維持不變。" },
        "relic_darkelf_chainsword": { n: "暗精靈鎖鏈劍",     type: "wpn", w2h: true, chainsword: true, weakExpose: true, relic: true, noEnhance: true, dmgS: 22, dmgL: 16, hit: 8, dmgBonus: 8, hpR: 10, extraMp: 5, spellProc: { skn: "吸血鬼之吻", dice: [2, 10], flat: 10, ele: "none", heal: 1.0 }, procRateBase: 10, procRatePerEn: 0, prototypePolicy: { family: "鎖鏈劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "dragon", p: 10000, gachaWeight: 0, d: "【遺物】闇精靈王御用的鎖鏈劍。犧牲小型纏足、保留大型扯甲；弱點曝光與吸血鬼之吻維持不變。" },
        ...
        "relic_fighter_axe":        { n: "鬥士的老舊戰斧",   type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 18, dmgL: 18, hit: 9, dmgBonus: 9, eff: "crush", hardWear: 100, prototypePolicy: { family: "雙手鈍器", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,illusion,dragon,warrior", p: 10000, gachaWeight: 0, d: "【遺物】骷髏鬥士的老舊戰斧。犧牲小型震盪、保留大型破勢；耐磨重刃專門崩解堅甲硬皮。" },
        ...
        "relic_darkelf_grindblade": { n: "黑暗殘兵的研磨利刃", type: "wpn", relic: true, noEnhance: true, ignHardSkin: true, dmgS: 10, dmgL: 12, hit: 15, dmgBonus: 14, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 30 } } }, req: "royal,knight,elf,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】研磨至極的單手武士刀。犧牲小型橫掃、強化大型震盪；無視硬皮維持不變。" },
        ...
        "relic_dream_mushroom_soul":{ n: "夢幻的蘑菇靈魂",   type: "wpn", qigu: true, relic: true, noEnhance: true, dmgS: 28, dmgL: 28, hit: 0, int: 1, wis: 2, extraMp: 11, procPoison: { rate: 30, dmg: [10, 1], dur: 10, tick: 1 }, prototypePolicy: { family: "奇古獸", small: { mode: "enhance", changes: { delayTicks: 3, cooldownTicks: 50 } }, large: { mode: "sacrifice" } }, req: "illusion", p: 10000, gachaWeight: 0, d: "【遺物】夢幻之島蘑菇凝聚的靈魂。強化小型幻壓、犧牲大型回靈；必中魔法與劇毒維持不變。" },
        "relic_wisp_remnant":       { n: "幽光的殘念",       type: "wpn", relic: true, noEnhance: true, dmgS: 10, dmgL: 12, hit: 13, dmgBonus: 12, onHitEleDmg: { dmg: 30, ele: "fire" }, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】夢幻之島鬼火凝成的殘念。犧牲小型橫掃、保留大型震盪；命中火焰維持不變。" },
        "relic_frostdeath_breath":  { n: "殘冰的死亡氣息",   type: "wpn", w2h: true, isWand: true, relic: true, noEnhance: true, ignHardSkin: true, eff: "magicburst", freeChill: true, dmgS: 9, dmgL: 9, hit: 10, dmgBonus: 9, extraMp: 7, int: 1, prototypePolicy: { family: "魔杖", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "mage", p: 10000, gachaWeight: 0, d: "【遺物】冰人臨終凝成的雙手魔杖。保留小型施法干擾、犧牲大型震盪；寒意與魔力加成維持不變。" },
        ...
        "relic_summoner_whip":      { n: "喚獸師的訓練鞭",   type: "wpn", relic: true, noEnhance: true, eff: "crush", dmgS: 6, dmgL: 4, hit: 8, dmgBonus: 8, summonDmg: 3, summonHit: 6, petDmgAll: 6, petHitAll: 3, prototypePolicy: { family: "單手鈍器", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,mage,illusion,dragon,warrior", p: 10000, gachaWeight: 0, d: "【遺物】喚獸師馴服百獸的長鞭。犧牲小型震盪、保留大型破勢；召喚物與寵物加成維持不變。" },
        ...
        "relic_griffin_claw":       { n: "獅鷲的鋒利鷹爪",   type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "combo", comboRate: 50, mcritDmg: 10, dmgS: 20, dmgL: 18, hit: 13, dmgBonus: 14, prototypePolicy: { family: "鋼爪", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】格利芬鋒利的巨爪。犧牲小型撕甲、保留大型牽扯；50%雙擊與爆擊傷害維持不變。" },
        ...
        "relic_croc_fang":          { n: "巨大鱷魚的狩獵牙", type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "cleave", ignHardSkin: true, hardSkinMult: 1.5, dmgS: 17, dmgL: 21, hit: 13, dmgBonus: 16, prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 6, cooldownTicks: 30 } } }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】巨大鱷魚的狩獵利牙。犧牲小型橫掃、強化大型震盪；厚甲硬皮追擊倍率維持單一來源。" },
        "relic_icestone_maul":      { n: "冰石的強襲鎚",     type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "crush", prototypePolicy: { family: "雙手鈍器", small: { mode: "enhance", changes: { delayTicks: 5, cooldownTicks: 30 } }, large: { mode: "sacrifice" } }, ele: "water", onHitEleDmg: { dmg: 10, ele: "water" }, procStatusSkill: { skId: "sk_relic_freeze", rate: 1 }, dmgS: 18, dmgL: 24, hit: 10, dmgBonus: 10, req: "royal,knight,dragon,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】冰石高崙揮舞的強襲鎚。強化小型震盪、犧牲大型破勢；命中追加 10 點水屬性傷害，並有 1% 機率觸發冰凍。" },
        ...
        "relic_mutant_lamia_scale": { n: "變種蛇女的詭異鱗片", type: "wpn", relic: true, noEnhance: true, prototypePolicy: { family: "匕首", small: { mode: "keep" }, large: { mode: "sacrifice" } }, ignHardSkin: true, unBonus: true, dmgS: 7, dmgL: 7, hit: 9, dmgBonus: 11, procStatusSkill: { skId: "sk_relic_paralyze", rate: 1 }, procPoison: { rate: 100, dmg: [10, 1], dur: 10, tick: 1 }, req: "royal,knight,elf,mage,dark", p: 10000, gachaWeight: 0, d: "【遺物】變種蛇女鋒利帶毒的鱗片。保留小型貫穿、犧牲大型破勢；必定施毒，另有 1% 機率觸發麻痺。" },
        ...
        "relic_giant_toothpick":    { n: "巨人戰士的牙籤",   type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "cleave", ignHardSkin: true, procStatusSkill: { skId: "sk_relic_stun", rate: 1 }, dmgS: 20, dmgL: 17, hit: 14, dmgBonus: 17, prototypePolicy: { family: "雙手劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】巨人戰士隨手的牙籤。保留小型橫掃、犧牲大型震盪，避免與原有暈眩重複控制。" },
        "relic_giant_throwstone":   { n: "巨人的拋投石",     type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "crush", dr: 3, procStatusSkill: { skId: "sk_relic_broken", rate: 5 }, dmgS: 18, dmgL: 24, hit: 12, dmgBonus: 12, prototypePolicy: { family: "雙手鈍器", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 3, durationTicks: 50 } } }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】巨人拋投的巨石。犧牲小型震盪、強化大型破勢；原有碎甲觸發與傷害減免維持不變。" },
        ...
        "relic_armor_spareblade":   { n: "詛咒鎧甲的備用刀", type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "combo", comboRate: 25, unBonus: true, dmgS: 11, dmgL: 8, hit: 14, dmgBonus: 11, prototypePolicy: { family: "雙刀", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】活鎧甲備用的雙刀。保留小型壓制、犧牲大型破勢，不死剋制與雙擊維持不變。" },
        "relic_beholder_gaze":      { n: "眼魔的凝視",       type: "wpn", isWand: true, relic: true, noEnhance: true, eff: "magicstrike", str: 4, procStatusSkill: { skId: "sk_relic_stone", rate: 1 }, dmgS: 9, dmgL: 9, hit: 13, dmgBonus: 16, prototypePolicy: { family: "魔杖", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】眼魔封存的凝視。保留小型施法干擾、犧牲大型震盪；石化與力量加成維持不變。" },
        ...
        "relic_veteran_greatsword": { n: "資深殘兵的重型劍", type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "cleave", counterBarrierX2: true, dmgS: 17, dmgL: 21, hit: 11, dmgBonus: 15, prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】資深殘兵慣用的重型劍。犧牲小型橫掃、保留大型震盪；老練的格擋反擊維持不變。" },
        "relic_thorn_needle":       { n: "刺針",             type: "wpn", relic: true, noEnhance: true, prototypePolicy: { family: "匕首", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 30 } } }, ignHardSkin: true, unBonus: true, raceBonus: { race: "蜘蛛", mult: 3 }, dmgS: 8, dmgL: 8, hit: 14, dmgBonus: 16, req: "royal,knight,elf,mage,dark", p: 10000, gachaWeight: 0, d: "【遺物】專為獵殺蛛類而鑄的刺針。犧牲小型貫穿、強化大型破勢；對蜘蛛維持 3 倍傷害，不再增加其他倍率。" },
        ...
        "relic_cockatrice_gaze":    { n: "石化雞蛇的凝視",   type: "wpn", w2h: true, chainsword: true, relic: true, noEnhance: true, weakExpose: true, procStatusSkill: { skId: "sk_mummy_curse", rate: 5 }, int: 1, wis: 2, dmgS: 23, dmgL: 20, hit: 15, dmgBonus: 14, prototypePolicy: { family: "鎖鏈劍", small: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 40 } }, large: { mode: "sacrifice" } }, req: "dragon", p: 10000, gachaWeight: 0, d: "【遺物】石化雞蛇凝望的視線封入鎖鏈劍。強化小型纏足、犧牲大型扯甲；弱點曝光與石化維持不變。" },
        // 🏺 遺物 第八批（v3.1.21·3 件）
        ...
        // 🏺 遺物 第九批（v3.1.28·10 件）
        "relic_aruba_haste":        { n: "阿魯巴的加速棍棒", type: "wpn", relic: true, noEnhance: true, eff: "crush", prototypePolicy: { family: "單手鈍器", small: { mode: "keep" }, large: { mode: "sacrifice" } }, atkSpdPct: 20, dmgS: 4, dmgL: 4, hit: 17, dmgBonus: 15, req: "royal,knight,elf,dragon,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】阿魯巴揮舞的加速棍棒。保留小型震盪、犧牲大型破勢，以此換取攻擊速度 +20%。" },
        "relic_ashwarrior_flamesword": { n: "灰燼戰士的火焰長劍", type: "wpn", relic: true, noEnhance: true, ele: "fire", onHitEleDmg: { ele: "fire", dmg: 50, rate: 3 }, dmgS: 8, dmgL: 12, hit: 12, dmgBonus: 12, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,elf,mage,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】灰燼戰士至死緊握的長劍。犧牲小型橫掃、保留大型震盪；火屬性與餘燼傷害維持不變。" },
        "relic_deadgeneral_greatsword": { n: "不死將軍的珍愛巨劍", type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "cleave", softMult: 1.3, dmgS: 20, dmgL: 17, hit: 12, dmgBonus: 15, prototypePolicy: { family: "雙手劍", small: { mode: "enhance", changes: { every: 3, splashPct: 54, maxTargets: 2 } }, large: { mode: "sacrifice" } }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】不死將軍生前珍愛的雙手巨劍。強化小型橫掃波及、犧牲大型震盪；血肉追擊倍率維持單一來源。" },
        ...
        "relic_darkscorpion_pincers": { n: "暗黑蠍的雙鉗",   type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "combo", comboRate: 30, prototypePolicy: { family: "雙刀", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 40 } } }, procSkill: "sk_demon_kiss", procRateBase: 4, procRatePerEn: 0, ele: "earth", poisonMult: 1.2, dmgS: 16, dmgL: 11, hit: 12, dmgBonus: 13, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】暗黑蠍的一對毒鉗。犧牲小型壓制、強化大型破勢；雙擊、劇毒與惡魔之吻維持不變。" },
        "relic_forgotten_sniperbow": { n: "遺忘者的狙擊弓",  type: "wpn", isBow: true, ranged: true, oneHand: true, relic: true, noEnhance: true, rapidfire: 80, fullHpMult: 3, fullHpMultTriple: 2, dmgS: 3, dmgL: 3, hit: 13, dmgBonus: 14, prototypePolicy: { family: "十字弓", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "elf", p: 10000, gachaWeight: 0, d: "【遺物】遺忘者遺留的單手狙擊弓。犧牲小型穿甲破勢、保留大型震盪；滿血狙擊仍是唯一主要傷害倍率。" },
        ...
        "relic_evillizard_eye":     { n: "邪惡蜥蜴的眼瞳",   type: "wpn", isWand: true, relic: true, noEnhance: true, mpOnHit: true, mpOnHitAmt: 6, procStatusSkill: { skId: "sk_mummy_curse", rate: 3 }, extraMp: 3, dmgS: 3, dmgL: 3, hit: 11, dmgBonus: 11, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】邪惡蜥蜴凝固眼瞳鑲成的魔杖。犧牲小型施法干擾、保留大型震盪；吸魔與木乃伊詛咒維持不變。" },
        ...
        // 🏺 遺物 第十批（v3.1.32·5 件）
        "relic_modded_crossbow":    { n: "擅自改造的十字弓", type: "wpn", isBow: true, ranged: true, oneHand: true, relic: true, noEnhance: true, rapidfire: 100, dex: 2, dmgS: 3, dmgL: 3, hit: 11, dmgBonus: 12, prototypePolicy: { family: "十字弓", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "elf,dark,illusion", p: 10000, gachaWeight: 0, d: "【遺物】被人擅自改造過的單手十字弓。保留小型穿甲破勢、犧牲大型震盪，以100%連射維持箭雨特色。" },
        "relic_medusa_stinger":     { n: "蛇妖的無慈悲尾刺", type: "wpn", relic: true, noEnhance: true, eff: "crush", stoneInstakill: true, dmgS: 9, dmgL: 10, hit: 9, dmgBonus: 9, prototypePolicy: { family: "單手鈍器", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 40 } } }, req: "royal,knight,elf,dragon,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】蛇妖斷落的無慈悲尾刺。犧牲小型震盪、強化大型破勢；石化即死特性維持不變。" },
        "relic_silent_venom":       { n: "沉默的毒液",       type: "wpn", relic: true, noEnhance: true, prototypePolicy: { family: "單手矛", small: { mode: "keep" }, large: { mode: "sacrifice" } }, procStatusSkill: { skId: "sk_relic_silence", rate: 3 }, silencedBonusDmg: 20, dmgS: 8, dmgL: 8, hit: 13, dmgBonus: 13, req: "royal,knight,elf,warrior", p: 10000, gachaWeight: 0, d: "【遺物】滴淌沉默毒液的單手矛。保留小型貫穿、犧牲大型破勢；3% 觸發沉默，對沉默目標額外造成 20 點傷害。" },
        ...
        "relic_axetaurus_brutalaxe": { n: "牛頭怪的殘暴巨斧", type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "crush", prototypePolicy: { family: "雙手鈍器", small: { mode: "keep" }, large: { mode: "sacrifice" } }, atkSpdPct: 25, dmgS: 22, dmgL: 24, hit: 11, dmgBonus: 11, req: "royal,knight,dragon,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】巨斧牛人揮舞的殘暴巨斧。保留小型震盪、犧牲大型破勢，以此換取攻擊速度 +25%。" },
        ...
        "relic_fearless_charge":    { n: "無所畏懼的突擊",     type: "wpn", w2h: true, chainsword: true, weakExpose: true, relic: true, noEnhance: true, dmgS: 24, dmgL: 16, hit: 15, dmgBonus: 19, str: 2, hpR: 5, procStatusSkill: { skId: "sk_relic_stun", rate: 1 }, prototypePolicy: { family: "鎖鏈劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "dragon", p: 10000, gachaWeight: 0, d: "【遺物】無畏衝鋒者緊握的鎖鏈劍。犧牲小型纏足、保留大型扯甲；弱點曝光與暈眩維持不變。" },
        "relic_lizard_tongue":      { n: "灼熱蜥蜴長舌",       type: "wpn", relic: true, noEnhance: true, dmgS: 10, dmgL: 10, hit: 12, dmgBonus: 12, prototypePolicy: { family: "單手矛", small: { mode: "enhance", changes: { chance: 25, splashPct: 35 } }, large: { mode: "sacrifice" } }, ele: "fire", onHitEleVuln: "fire", req: "royal,knight,elf,mage,warrior", p: 10000, gachaWeight: 0, d: "【遺物】灼熱蜥蜴長舌鍛成的矛。強化小型貫穿、犧牲大型破勢；攻擊為火屬性並使目標短暫獲得火焰弱點。" },
        ...
        "relic_killerbee_sting":    { n: "殺人蜂的尾刺",       type: "wpn", relic: true, noEnhance: true, dmgS: 7, dmgL: 7, hit: 9, dmgBonus: 9, hasteStrike: true, prototypePolicy: { family: "匕首", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "royal,knight,elf,mage,dark", p: 10000, gachaWeight: 0, d: "【遺物】殺人蜂的致命尾刺。保留小型貫穿、犧牲大型破勢；疾風般的急速攻擊維持不變。" },
        ...
        "relic_ancient_spider_claw":{ n: "上古蜘蛛之爪",       type: "wpn", relic: true, noEnhance: true, dmgS: 16, dmgL: 10, hit: 15, dmgBonus: 14, raceFlat: { race: "動物", add: 10 }, prototypePolicy: { family: "單手劍", small: { mode: "enhance", changes: { every: 4, splashPct: 50, maxTargets: 1 } }, large: { mode: "sacrifice" } }, req: "knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】上古巨蜘蛛蛻下的尖爪。強化小型橫掃波及、犧牲大型震盪；動物追擊維持不變。" },
        ...
        "relic_guardian_greatsword":{ n: "鎧甲守衛的笨重巨劍", type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 40, dmgL: 40, hit: 3, dmgBonus: 3, eff: "cleave", str: 3, atkSpdPct: -50, heavyMult: 1.5, prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】鎧甲守衛揮舞的笨重巨劍。犧牲小型橫掃、保留大型震盪；重型追擊與緩慢攻速維持不變。" },
        "relic_dream_flamesoul":    { n: "幻夢的火炎靈魂",     type: "wpn", qigu: true, relic: true, noEnhance: true, dmgS: 24, dmgL: 24, hit: 0, int: 2, extraMp: 23, procSkill: "sk_fireball", procRateBase: 4, procRatePerEn: 0, prototypePolicy: { family: "奇古獸", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "illusion", p: 10000, gachaWeight: 0, d: "【遺物】幻夢中的火炎靈魂。犧牲小型幻壓、保留大型回靈；必中魔法與火球維持不變。" },
        ...
        "relic_lightbeam_wand":     { n: "光束強化魔杖",       type: "wpn", isWand: true, relic: true, noEnhance: true, dmgS: 3, dmgL: 3, hit: 9, dmgBonus: 9, mdmg: 2, skillDmgMult: { "sk_lightarrow": 1.5, "sk_disintegrate": 1.5 }, prototypePolicy: { family: "魔杖", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "mage", p: 10000, gachaWeight: 0, d: "【遺物】強化光束的魔杖。保留小型施法干擾、犧牲大型震盪；光箭與究極光裂術倍率維持單一來源。" },
        // ===== 🐍 蛇神降臨·提卡爾 庫庫爾坎傳說裝備（庫庫爾坎寶箱開出·legend） =====
        "wpn_kukulkan_spear":    { n: "提卡爾庫庫爾坎之矛", legend: true, type: "wpn", w2h: true, noBleed: true, dmgS: 24, dmgL: 20, hit: 5, dmgBonus: 0, eff: "pierce", pierceChance: 90, prototypePolicy: { family: "雙手矛", small: { mode: "keep" }, large: { mode: "replace", mechanic: { effect: "stagger", delayTicks: 4, cooldownTicks: 30 } } }, ignHardSkin: true, strawCurse: { rate: 4, stacks: 3 }, dex: 2, mr: 5, req: "royal,knight,warrior", safe: 6, p: 235000, gachaWeight: 1, d: "庫庫爾坎神廟守衛執掌的巨矛；保留貫穿，對大型敵人的破勢則被羽蛇震盪取代。" },
        "wpn_kukulkan_gauntlet": { n: "提卡爾庫庫爾坎鐵手甲", legend: true, type: "wpn", isBow: true, ranged: true, animFam: "gauntlet", rapidfire: 100, dmgS: 3, dmgL: 3, hit: 0, dmgBonus: 4, strawCurse: { rate: 4, stacks: 3 }, dex: 1, mhp: 30, sizeMechanics: { small: { effect: "stagger", delayTicks: 2, cooldownTicks: 40 }, large: { effect: "suppress", durationTicks: 20, cooldownTicks: 50 } }, req: "dark,dragon", safe: 6, p: 235000, gachaWeight: 1, d: "羽蛇鱗片鍛成的高速投射鐵手甲。對小型牽制、對大型壓制；箭矢消耗與稻草詛咒維持原有判定。" },
        ...
        "relic_yuka_blowdart":  { n: "艾庫尤卡的吹箭",       type: "wpn", isBow: true, ranged: true, relic: true, noEnhance: true, ignHardSkin: true, rapidfire: 30, atkSpdPct: 30, dmgS: 2, dmgL: 2, hit: 12, dmgBonus: 9, prototypePolicy: { family: "投射器", small: { mode: "enhance", changes: { delayTicks: 3, cooldownTicks: 40 } }, large: { mode: "sacrifice" } }, req: "elf,mage,dark,illusion", p: 10000, gachaWeight: 0, d: "【遺物】艾庫尤卡的毒吹箭。強化小型牽制、犧牲大型壓制；高速連射、攻速與硬皮穿透維持不變。" },
        ...
        "relic_kaira_fang":     { n: "艾庫卡伊拉的毒牙",     type: "wpn", relic: true, noEnhance: true, dmgS: 9, dmgL: 9, hit: 13, dmgBonus: 8, procPoison: { rate: 3, dmg: [10, 1], dur: 10, tick: 1 }, poisonedBonusDmg: 15, prototypePolicy: { family: "匕首", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,elf,mage,knight,dark", p: 10000, gachaWeight: 0, d: "【遺物】艾庫卡伊拉的滴毒獠牙。犧牲小型貫穿、保留大型破勢；毒咒與中毒追擊維持不變。" },
        ...
        "relic_eto_whip":       { n: "艾庫艾托的鞭笞藤",     type: "wpn", w2h: true, noBleed: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 17, dmgL: 17, hit: 12, dmgBonus: 12, eff: "pierce", pierceChance: 100, procStatusSkill: { skId: "sk_relic_slow", rate: 5 }, slowedBonusDmg: 10, prototypePolicy: { family: "雙手矛", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "knight,elf,warrior", p: 10000, gachaWeight: 0, d: "【遺物】艾庫艾托的鞭笞藤蔓。保留小型貫穿、犧牲大型破勢；緩速與遲滯追擊維持不變。" },
        "relic_eto_wand":       { n: "艾庫艾托的枯竭魔杖",   type: "wpn", w2h: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 9, dmgL: 9, hit: 9, dmgBonus: 9, eff: "magicburst", autoCastMpMult: 2, autoCastDmgMult: 1.5, mdmg: 5, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "sacrifice" } }, req: "mage", p: 10000, gachaWeight: 0, d: "【遺物】艾庫艾托枯竭的魔杖。兩項原型皆犧牲，力量集中於加倍耗魔與自動施法傷害倍率。" },
        "relic_mud_idol":       { n: "特產易碎泥偶",         type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 20, dmgL: 20, hit: 13, dmgBonus: 11, eff: "crush", selfBreakProc: { dur: 5 }, prototypePolicy: { family: "雙手鈍器", small: { mode: "enhance", changes: { delayTicks: 5, cooldownTicks: 30 } }, large: { mode: "sacrifice" } }, req: "royal,knight,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】提卡爾特產的易碎泥偶。強化小型震盪、犧牲大型破勢；猛烈爆裂與反噬維持不變。" },
        ...
        "relic_ska_soul":       { n: "阿茲特獻祭亡靈",       type: "wpn", qigu: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 26, dmgL: 26, hit: 0, int: 3, con: -3, mpR: 10, extraMp: 13, procInstakill: { p: 0.01, tag: null, healPct: 0.05 }, prototypePolicy: { family: "奇古獸", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { mp: 2, cooldownTicks: 40 } } }, req: "illusion", p: 10000, gachaWeight: 0, d: "【遺物】阿茲特獻祭的亡靈化成奇古獸。犧牲小型幻壓、強化大型回靈；必中魔法、即死與生命回復維持不變。" },
        ...
        "relic_teo_hammer":     { n: "薩德提歐的玩具鎚",     type: "wpn", relic: true, noEnhance: true, dmgS: 13, dmgL: 12, hit: 11, dmgBonus: 13, prototypePolicy: { family: "單手鈍器", small: { mode: "keep" }, large: { mode: "sacrifice" } }, ele: "wind", req: "royal,knight,elf,dragon,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】薩德提歐揮舞的玩具鎚。保留小型震盪、犧牲大型破勢，掄起時帶出風屬性狂風。" },
        ...
        "relic_serpent_fang":   { n: "蛇神的倒勾獠牙",       type: "wpn", w2h: true, noBleed: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 24, dmgL: 20, hit: 28, dmgBonus: 13, eff: "pierce", pierceChance: 90, strawCurse: { rate: 8, stacks: 3 }, dex: 2, mr: 5, prototypePolicy: { family: "雙手矛", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "knight,elf,warrior", p: 10000, gachaWeight: 0, d: "【遺物】羽蛇神杰弗雷庫的倒勾獠牙。保留小型貫穿、犧牲大型破勢；滅亡詛咒與靈巧加成維持不變。" },
        ...
        "relic_executor_axe":      { n: "處刑人的護身斧",     type: "wpn", relic: true, noEnhance: true, dmgS: 13, dmgL: 13, hit: 14, dmgBonus: 14, procHealFlat: { rate: 3, hp: 10 }, prototypePolicy: { family: "單手鈍器", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "warrior", p: 10000, gachaWeight: 0, d: "【遺物】處刑人隨身護命的短柄斧。犧牲小型震盪、保留大型破勢；飲血療傷維持不變。" },
        "relic_executor_skewer":   { n: "處刑者的串刺刑具",   type: "wpn", w2h: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 21, dmgL: 21, hit: 19, dmgBonus: 14, eff: "pierce", pierceChance: 100, unBonus: true, mhp: 80, prototypePolicy: { family: "雙手矛", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 3, durationTicks: 50 } } }, req: "royal,knight,warrior", p: 10000, gachaWeight: 0, d: "【遺物】處刑者用以貫穿死囚的長刺。犧牲小型貫穿、強化大型破勢；不死加成與生命加成維持不變。" },
        "relic_jack_sling":        { n: "傑克的彈弓",         type: "wpn", isBow: true, ranged: true, relic: true, noEnhance: true, ignHardSkin: true, rapidfire: 80, giantBonus: true, atkSpdPct: 20, dmgS: 2, dmgL: 2, hit: 12, dmgBonus: 16, prototypePolicy: { family: "投射器", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { durationTicks: 30, cooldownTicks: 50 } } }, req: "elf,dark,illusion", p: 10000, gachaWeight: 0, d: "【遺物】傑克攀上魔豆藤時帶著的彈弓。犧牲小型牽制、強化大型壓制；巨人加成、攻速與硬皮穿透維持不變。" },
        ...
        "relic_blacktiger_whip":   { n: "黑虎的雙尾鞭",       type: "wpn", w2h: true, chainsword: true, weakExpose: true, relic: true, noEnhance: true, dmgS: 23, dmgL: 23, hit: 17, dmgBonus: 14, eff: "pierce", pierceChance: 50, classicOk: true, dex: 2, ele: "water", prototypePolicy: { family: "鎖鏈劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "dragon", p: 10000, gachaWeight: 0, d: "【遺物】黑虎雙尾化成的鎖鏈長鞭。犧牲小型纏足、保留大型扯甲；弱點曝光、貫穿與水屬性維持不變。" },
        ...
        "relic_healer_wand":       { n: "治癒者的恢復魔棒",   type: "wpn", relic: true, noEnhance: true, dmgS: 8, dmgL: 8, hit: 11, dmgBonus: 11, prototypePolicy: { family: "單手鈍器", small: { mode: "sacrifice" }, large: { mode: "keep" } }, mpR: 20, groupHealMult: 2, req: "mage,elf", p: 10000, gachaWeight: 0, d: "【遺物】強化白螞蟻體液浸潤的恢復魔棒。犧牲小型震盪、保留大型破勢；MP 恢復 +20，體力回復術與生命的祝福恢復量 ×2。" },
        ...
        "relic_shadow_stinger":    { n: "來自陰影的刺劍",     type: "wpn", relic: true, noEnhance: true, dmgS: 9, dmgL: 9, hit: 16, dmgBonus: 11, prototypePolicy: { family: "匕首", small: { mode: "enhance", changes: { chance: 25, splashPct: 30 } }, large: { mode: "sacrifice" } }, procInstakill: { p: 1, tag: null, hpBelow: 0.10 }, req: "royal,knight,mage,elf,dark", p: 10000, gachaWeight: 0, d: "【遺物】影魔自陰影遞出的刺劍。強化小型貫穿、犧牲大型破勢；命中生命低於 10% 的非頭目必定處決。" },
        "relic_weathered_obelisk": { n: "風化的巨型方尖碑",   type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 26, dmgL: 26, hit: 12, dmgBonus: 16, eff: "crush", heavyRatePct: 10, ele: "wind", prototypePolicy: { family: "雙手鈍器", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,dragon,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】尖碑石奴背負的風化方尖碑。犧牲小型震盪、保留大型破勢；重擊與千年風沙維持不變。" },
        "relic_soulreaper_dual":   { n: "奪魂者雙刃劍",       type: "wpn", w2h: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 18, dmgL: 14, hit: 18, dmgBonus: 17, eff: "combo", comboRate: 30, prototypePolicy: { family: "雙刀", small: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 40 } }, large: { mode: "sacrifice" } }, onHitCastSkill: { skId: "sk_cold_shiver", cdSec: 5 }, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】魂騎士的奪魂雙刃。強化小型壓制、犧牲大型破勢；雙擊與寒顫觸發維持不變。" },
        ...
        "relic_minotaur_flail":    { n: "牛頭人的流星鎚",     type: "wpn", relic: true, noEnhance: true, dmgS: 9, dmgL: 10, hit: 15, dmgBonus: 15, prototypePolicy: { family: "單手鈍器", small: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 30 } }, large: { mode: "sacrifice" } }, procStatusSkill: { skId: "sk_relic_stun", rate: 2 }, req: "royal,knight,elf,dragon,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】鏈鎚牛人掄轉的流星鎚。強化小型震盪、犧牲大型破勢；命中時 2% 機率觸發暈眩。" },
        ...
        "relic_succubus_wand":     { n: "思克巴女皇的熱情魔杖", type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 9, dmgL: 9, hit: 8, dmgBonus: 8, eff: "magicburst", ele: "fire", procFireSkillRate: 10, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】思克巴女皇的熱情魔杖。犧牲小型施法干擾、保留大型震盪；火屬性法術觸發維持不變。" },
        ...
        "relic_warlock_grimoire":  { n: "巫師的黑暗魔導書",   type: "wpn", isWand: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 3, dmgL: 3, hit: 7, dmgBonus: 7, mdmg: 3, extraMp: 5, fullHpMpHalf: true, prototypePolicy: { family: "魔杖", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "mage", p: 10000, gachaWeight: 0, d: "【遺物】巫師畢生鑽研的黑暗魔導書。保留小型施法干擾、犧牲大型震盪；滿血省魔維持不變。" },
        ...
        "relic_ghoul_fang":      { n: "兇殘惡鬼的毒牙",   type: "wpn", relic: true, noEnhance: true, dmgS: 9, dmgL: 11, hit: 15, dmgBonus: 15, prototypePolicy: { family: "單手劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, ele: "earth", eleBonusDmg: { ele: "wind", add: 10 }, req: "royal,knight,elf,mage,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】殘暴食屍鬼口中的毒牙。保留小型橫掃、犧牲大型震盪；地屬性攻擊對風屬性敵人額外造成 10 點傷害。" },
        "relic_sparto_shard":    { n: "殘暴骸骨的破片",   type: "wpn", relic: true, noEnhance: true, dmgS: 4, dmgL: 5, hit: 14, dmgBonus: 13, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, unBonus: true, req: "royal,knight,elf,mage,dark,dragon", p: 10000, gachaWeight: 0, d: "【遺物】殘暴史巴托碎裂的骸骨破片。犧牲小型橫掃、保留大型震盪，並對不死生物與狼人造成額外傷害。" },
        "relic_corpse_needle":   { n: "屍毒之針",         type: "wpn", isBow: true, ranged: true, oneHand: true, rapidfire: 65, relic: true, noEnhance: true, dmgS: 3, dmgL: 2, hit: 16, dmgBonus: 15, procStatusSkill: { skId: "sk_relic_paralyze", rate: 3 }, immParalyzeBonusDmg: 5, prototypePolicy: { family: "投射器", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "knight,elf,dark,illusion", p: 10000, gachaWeight: 0, d: "【遺物】淬滿屍毒的單手細針。保留小型牽制、犧牲大型壓制；連射、麻痺與抗麻痺追擊維持不變。" },
        "relic_morph_blade":     { n: "不定形的變幻劍",   type: "wpn", w2h: true, chainsword: true, weakExpose: true, relic: true, noEnhance: true, dmgS: 21, dmgL: 17, hit: 17, dmgBonus: 15, str: 1, counterAllEle: true, prototypePolicy: { family: "鎖鏈劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "dragon", p: 10000, gachaWeight: 0, d: "【遺物】不斷變幻形貌的鎖鏈劍。保留小型纏足、犧牲大型扯甲；弱點曝光與四屬性反制維持不變。" },
        ...
        "relic_pirate_dual":     { n: "傳說海賊的迷幻雙刀", type: "wpn", w2h: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 15, dmgL: 10, hit: 18, dmgBonus: 16, eff: "combo", comboRate: 30, ele: "water", dex: 3, prototypePolicy: { family: "雙刀", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】傳說海賊的迷幻雙刀。保留小型壓制、犧牲大型破勢；水屬性、敏捷與雙擊維持不變。" },
        "relic_lava_fists":      { n: "熔岩灼燒的雙拳",   type: "wpn", relic: true, noEnhance: true, ignHardSkin: true, dmgS: 15, dmgL: 15, hit: 12, dmgBonus: 13, unBonus: true, ele: "fire", procBurn: { dmg: 20, dur: 6 }, prototypePolicy: { family: "單手鈍器", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "warrior", p: 10000, gachaWeight: 0, d: "【遺物】熔岩高崙熔鑄的雙拳。保留小型震盪、犧牲大型破勢；火焰、不死加成與持續燃燒維持不變。" },
        ...
        "relic_monkey_staff":    { n: "猴子的金箍棒",     type: "wpn", relic: true, noEnhance: true, eff: "crush", ignHardSkin: true, dmgS: 6, dmgL: 3, hit: 6, dmgBonus: 6, lvDmgDiv: 5, lvHitDiv: 5, prototypePolicy: { family: "單手鈍器", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "royal,knight,elf,mage,illusion,dragon,warrior", p: 10000, gachaWeight: 0, d: "【遺物】猴王隨心變化的如意金箍棒。保留小型震盪、犧牲大型破勢；隨等級成長的傷害與命中維持不變。" },
        ...
        "relic_fireking_blast": { n: "火精靈王的爆焰", type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 17, dmgL: 21, hit: 15, dmgBonus: 18, eff: "cleave", ele: "fire", hitEchoMagic: { rate: 10, ele: "fire" }, relicRole: "兼具切割攻速與命中爆破的近戰爆發武器", prototypePolicy: { family: "雙手劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】劍身封存著火精靈王未熄的核心。保留小型橫掃、犧牲大型震盪；命中爆焰維持不變。" },
        "relic_waterking_caress": { n: "水精靈王的撫摸", type: "wpn", relic: true, noEnhance: true, ignHardSkin: true, dmgS: 17, dmgL: 13, hit: 15, dmgBonus: 15, eff: "combo", comboRate: 35, ele: "water", missGrazeRate: 30, prototypePolicy: { family: "鋼爪", small: { mode: "keep" }, large: { mode: "sacrifice" } }, relicRole: "以雙擊、貫穿與擦傷補正穩定近戰輸出", req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】冷冽水流纏繞的爪刃。保留小型撕甲、犧牲大型牽扯；雙擊與擦傷補正維持不變。" },
        "relic_windking_roar": { n: "風精靈王的狂嘯", type: "wpn", isWand: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 3, dmgL: 3, hit: 15, dmgBonus: 15, ele: "wind", windSpellProcRate: 15, relicRole: "強化風屬性主動法術的連鎖爆發", prototypePolicy: { family: "魔杖", small: { mode: "enhance", changes: { durationTicks: 15, cooldownTicks: 40 } }, large: { mode: "sacrifice" } }, req: "mage", p: 10000, gachaWeight: 0, d: "【遺物】風精靈王不息的狂嘯。強化小型施法干擾、犧牲大型震盪；風屬性連鎖施法維持不變。" },
        "relic_earthking_resist": { n: "地精靈王的抗拒", type: "wpn", isBow: true, ranged: true, w2h: true, rapidfire: 65, relic: true, noEnhance: true, dmgS: 3, dmgL: 3, hit: 15, dmgBonus: 18, ele: "earth", hurtRapidfire: true, prototypePolicy: { family: "弓", small: { mode: "keep" }, large: { mode: "sacrifice" } }, relicRole: "兼具主動連射與受擊反制的遠距離武器", req: "elf,illusion", p: 10000, gachaWeight: 0, d: "【遺物】弓身承載地精靈王拒絕屈服的意志。保留小型牽制、犧牲大型破勢，受擊反制連射維持不變。" },
        ...
        "relic_rockmage_secret": { n: "破岩法師的秘術", type: "wpn", isWand: true, relic: true, noEnhance: true, ignHardSkin: true, dmgS: 3, dmgL: 3, hit: 15, dmgBonus: 15, extraMp: 15, ele: "earth", procSkill: "sk_hell_fang", procRateBase: 100, procRatePerEn: 0, relicRole: "以每次攻擊必定施法，補強魔法型普攻輸出", prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "sacrifice" } }, req: "mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】破岩法師封存的撼地秘術。兩項原型皆犧牲，力量集中於每次攻擊必定喚醒地底尖牙。" },
        ...
        "relic_cerberus_pin":    { n: "地獄犬三頭釵",       type: "wpn", relic: true, noEnhance: true, dmgS: 20, dmgL: 18, hit: 13, dmgBonus: 16, eff: "combo", comboRate: 35, ele: "fire", atkSpdPct: 33, prototypePolicy: { family: "鋼爪", small: { mode: "enhance", changes: { defense: 2, durationTicks: 30 } }, large: { mode: "sacrifice" } }, relicRole: "高攻速火屬性鋼爪，兼具35%雙擊與貫穿", req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】地獄犬頭顱化成的獠牙鋼釵。強化小型撕甲、犧牲大型牽扯；高攻速、火屬性與雙擊維持不變。" },
        ...
        "relic_dark_metal_club": { n: "暗黑的金屬棍棒",     type: "wpn", relic: true, noEnhance: true, dmgS: 6, dmgL: 8, hit: 18, dmgBonus: 15, prototypePolicy: { family: "單手鈍器", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 40 } } }, eleBonusDmg: { ele: "none", add: 10 }, relicRole: "高命中、貫穿的無屬性敵人專攻鈍器", req: "royal,knight,mage,elf,dragon,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】暗黑金屬鑄成的棍棒。犧牲小型震盪、強化大型破勢；對無屬性敵人額外造成 10 點傷害。" },
        ...
        "relic_ant_pincer":      { n: "斷裂的昆蟲巨鉗",     type: "wpn", relic: true, noEnhance: true, dmgS: 16, dmgL: 10, hit: 20, dmgBonus: 15, mcrit: 5, relicRole: "高命中單手劍，兼具近距離爆擊、反擊與居合", prototypePolicy: { family: "單手劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】斷裂後依然銳利的昆蟲巨鉗。保留小型橫掃、犧牲大型震盪；爆擊、反擊與居合維持不變。" },
        "relic_ocean_orb":       { n: "魔力塑造的海洋水晶球", type: "wpn", isWand: true, relic: true, noEnhance: true, eff: "magicstrike", dmgS: 15, dmgL: 15, hit: 20, dmgBonus: 17, str: 3, mdmg: 3, ele: "water", mpOnHit: true, onHitWet: true, relicRole: "水屬性魔戰武器，以潮濕放大下一次風屬性傷害", prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 3, cooldownTicks: 40 } } }, req: "mage", p: 10000, gachaWeight: 0, d: "【遺物】封存不眠之海的水晶球。犧牲小型施法干擾、強化大型震盪；吸魔與潮濕共鳴維持不變。" },
        "relic_ash_fist":        { n: "燃燒殆盡的灰燼之拳", type: "wpn", relic: true, noEnhance: true, dmgS: 4, dmgL: 4, hit: 16, dmgBonus: 14, ele: "fire", atkSpdPct: 30, relicRole: "高攻速火屬性鈍器，適合穩定快速輸出", prototypePolicy: { family: "單手鈍器", small: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 30 } }, large: { mode: "sacrifice" } }, req: "royal,knight,mage,elf,dragon,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】灰燼深處仍藏著灼人餘溫。強化小型震盪、犧牲大型破勢；火屬性與高攻速維持不變。" },
        "relic_reaper_scythe":   { n: "死神的鐮刀破片",     type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "cleave", ignHardSkin: true, dmgS: 21, dmgL: 30, hit: 18, dmgBonus: 14, mcritDmg: 30, relicRole: "貫穿型雙手劍，強化對大型目標與近距離爆擊傷害", prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 6, cooldownTicks: 30 } } }, req: "knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】死神鐮刀破片重鍛的劍刃。犧牲小型橫掃、強化大型震盪；近距離爆擊傷害維持單一來源。" },
        ...
        "relic_mini_darkelf":    { n: "被差遣的迷你闇精靈", type: "wpn", qigu: true, relic: true, noEnhance: true, dmgS: 25, dmgL: 25, hit: 0, int: 1, mdmg: 1, extraMp: 11, procSkill: "sk_darkwave", procRateBase: 8, procRatePerEn: 0, relicRole: "幻術士專用必中魔法型奇古獸，並機率觸發闇黑波動", prototypePolicy: { family: "奇古獸", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "illusion", p: 10000, gachaWeight: 0, d: "【遺物】被闇精靈王差遣而來的微小侍從。保留小型幻壓、犧牲大型回靈；必中魔法與闇黑波動維持不變。" },
        "relic_avenger_crossbow":{ n: "復仇者的十字弩弓",   type: "wpn", isBow: true, ranged: true, w2h: true, rapidfire: 75, relic: true, noEnhance: true, ignHardSkin: true, rapidMax: true, dmgS: 3, dmgL: 2, hit: 20, dmgBonus: 17, prototypePolicy: { family: "十字弓", small: { mode: "sacrifice" }, large: { mode: "keep" } }, relicRole: "高機率最大連射，發動時固定射出最大額外箭數", req: "elf,dark,illusion", p: 10000, gachaWeight: 0, d: "【遺物】弩臂刻滿黑暗復仇者的誓言。犧牲小型穿甲破勢、保留大型震盪；連射發動時仍固定射出最大額外箭數。" },
        ...
        "relic_bone_bow":        { n: "殘暴的骸骨意志之弓", type: "wpn", isBow: true, ranged: true, w2h: true, rapidfire: 80, relic: true, noEnhance: true, bonespike: true, dmgS: 3, dmgL: 3, hit: 16, dmgBonus: 13, prototypePolicy: { family: "弓", small: { mode: "sacrifice" }, large: { mode: "keep" } }, relicRole: "以連射累積骨刺，再由一般攻擊一次引爆", req: "elf,illusion", p: 10000, gachaWeight: 0, d: "【遺物】殘暴骸骨的不甘被扭成弓身。犧牲小型牽制、保留大型破勢；連射累積骨刺、普攻引爆的流程維持不變。" },
        ...
        "relic_mage_dagger":     { n: "法師的護身短刀",     type: "wpn", relic: true, noEnhance: true, dmgS: 2, dmgL: 3, hit: 8, dmgBonus: 6, prototypePolicy: { family: "匕首", small: { mode: "sacrifice" }, large: { mode: "keep" } }, castOnHurt: { rate: 20 }, relicRole: "法師專用受擊反擊武器，20%免費施放設定的自動攻擊傷害法術", req: "mage", p: 10000, gachaWeight: 0, d: "【遺物】法師護身用短刀。犧牲小型貫穿、保留大型破勢；受創時 20% 機率免費施放設定中的自動攻擊法術。" },
        ...
        "wpn_onmyoji_fan": { n: "陰陽師的扇子", type: "wpn", legend: true, isWand: true, dmgS: 2, dmgL: 2, hit: 4, dmgBonus: 4, ignHardSkin: true, mdmg: 4, mpR: 4, req: "mage,illusion", safe: 6, p: 385000, gachaWeight: 1, prototypePolicy: { family: "魔杖", small: { mode: "enhance", changes: { durationTicks: 15, cooldownTicks: 40 } }, large: { mode: "sacrifice" } }, d: "陰陽師驅使式神的摺扇。強化小型施法干擾、犧牲大型震盪；貫穿、魔法傷害、回魔與共鳴維持不變。" },
        ...
        "relic_sr_kettle_maul":  { n: "沸騰蒸氣的巨釜",     type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "crush", prototypePolicy: { family: "雙手鈍器", small: { mode: "sacrifice" }, large: { mode: "keep" } }, ignHardSkin: true, counterEles: ["earth", "fire"], dmgS: 22, dmgL: 24, hit: 14, dmgBonus: 14, req: "royal,knight,dragon,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】整座嗚釜妖釜倒提為鎚。犧牲小型震盪、保留大型破勢；蒸氣攻勢剋制地與火屬性敵人。" },
        "relic_sr_kama_blade":   { n: "鐮鼬的尾刃",         type: "wpn", relic: true, noEnhance: true, iaiCrit: true, mcritDmg: 10, dmgS: 16, dmgL: 10, hit: 18, dmgBonus: 18, prototypePolicy: { family: "單手劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】鎌鼬長兄尾端的鐮刃。保留小型橫掃、犧牲大型震盪；居合爆擊維持不變。" },
        ...
        "relic_sr_nue_tail":     { n: "毒鵺的黑尾",         type: "wpn", chainsword: true, relic: true, noEnhance: true, weakExpose: true, ignHardSkin: true, procPoisonPct: { pct: 50, dur: 6 }, atkSpdPct: 20, dmgS: 26, dmgL: 26, hit: 16, dmgBonus: 18, prototypePolicy: { family: "鎖鏈劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 40 } } }, req: "dragon", p: 10000, gachaWeight: 0, d: "【遺物】鵺的蛇頭黑尾製成的鎖鏈劍。犧牲小型纏足、強化大型扯甲；弱點曝光、劇毒與攻速維持不變。" },
        "relic_sr_tengu_fan":    { n: "天狗的羽扇",         type: "wpn", isBow: true, ranged: true, relic: true, noEnhance: true, rapidfire: 80, ignHardSkin: true, ele: "wind", onHitCastSkill: { skId: "sk_windblade", cdSec: 5 }, mdmg: 2, dmgS: 2, dmgL: 2, hit: 17, dmgBonus: 13, prototypePolicy: { family: "弓", small: { mode: "enhance", changes: { delayTicks: 3, cooldownTicks: 30 } }, large: { mode: "sacrifice" } }, req: "elf,illusion", p: 10000, gachaWeight: 0, d: "【遺物】天狗搧起狂風的羽團扇。強化小型牽制、犧牲大型破勢，每一擊仍可挾帶撕裂風刃。" },
        ...
        "relic_sr_kyuubi_wand":  { n: "九尾妖狐的怒火",     type: "wpn", isWand: true, relic: true, noEnhance: true, ignHardSkin: true, ele: "fire", procSkill: "sk_fireball", procRateBase: 15, procRatePerEn: 0, procSkill2: { skId: "sk_fire_storm", rate: 5 }, mdmg: 4, mpR: 6, dmgS: 2, dmgL: 2, hit: 16, dmgBonus: 16, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "sacrifice" } }, req: "mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】九尾妖狐怒火凝成的妖杖。兩項原型皆犧牲，力量集中於火球、烈炎風暴與狐火回魔。" },
        "relic_sr_ushioni_horn": { n: "牛鬼的斷角",         type: "wpn", w2h: true, noBleed: true, relic: true, noEnhance: true, eff: "pierce", pierceChance: 100, ignHardSkin: true, procStatusSkill: { skId: "sk_disease", rate: 15 }, heavyBonusDmg: 20, dmgS: 25, dmgL: 25, hit: 17, dmgBonus: 18, prototypePolicy: { family: "雙手矛", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight", p: 10000, gachaWeight: 0, d: "【遺物】牛鬼折斷的巨角削成的長矛。犧牲小型貫穿、保留大型破勢；疾病與重型目標追擊維持不變。" },
        ...
        "relic_bk_lance":        { n: "黑騎士的精銳長槍", type: "wpn", relic: true, noEnhance: true, dmgS: 8, dmgL: 10, hit: 15, dmgBonus: 15, prototypePolicy: { family: "單手矛", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,knight,warrior", p: 10000, gachaWeight: 0, d: "【遺物】黑騎士精銳部隊的長槍。犧牲小型貫穿、保留大型破勢；搭配漆黑塔盾時格檔提升至 100%，並獲得近傷 +15。" },
        "relic_water_orb":       { n: "水靈的魔力珠", type: "wpn", isWand: true, relic: true, noEnhance: true, frozenBonusDmg: 50, waterFreezeProc: { pct: 3, dur: 4 }, dmgS: 2, dmgL: 2, hit: 13, dmgBonus: 13, prototypePolicy: { family: "魔杖", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "mage", p: 10000, gachaWeight: 0, d: "【遺物】水靈之主凝成的魔力珠。保留小型施法干擾、犧牲大型震盪；水法冰凍與冰凍追擊維持不變。" },
        ...
        "relic_earthshatter_sword":{ n: "大地碎裂劍", type: "wpn", relic: true, noEnhance: true, dmgS: 10, dmgL: 11, hit: 13, dmgBonus: 17, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "replace", mechanic: { effect: "break_stance", defense: 2, durationTicks: 50 } } }, req: "royal,knight,mage,elf,dark,dragon", p: 10000, gachaWeight: 0, ignHardSkin: true, ele: "earth", slowScaleDmg: true, d: "【遺物】地靈之主崩解時凝成的單手劍。犧牲小型橫掃，將大型震盪替換為破勢；攻擊為地屬性，攻擊間隔每比 0.10 秒慢 0.05 秒，近傷 +1。" },
        "relic_gale_fistblade":    { n: "疾風拳刃", type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 12, dmgL: 16, hit: 15, dmgBonus: 12, req: "dark", p: 10000, gachaWeight: 0, eff: "combo", comboRate: 70, ignHardSkin: true, atkSpdPct: 35, windbladeProc: 3, prototypePolicy: { family: "鋼爪", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "【遺物】疾風凝成的拳刃。保留小型撕甲、犧牲大型牽扯；70%雙擊、攻速與風刃出血維持不變。" },
        "relic_hellfire_hammer":   { n: "業火鍛造鎚", type: "wpn", relic: true, noEnhance: true, eff: "crush", prototypePolicy: { family: "單手鈍器", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 40 } } }, dmgS: 8, dmgL: 6, hit: 13, dmgBonus: 13, req: "royal,knight,illusion,dragon,warrior", p: 10000, gachaWeight: 0, ignHardSkin: true, hardskinFireProc: true, d: "【遺物】火靈之主的業火鐵鎚。犧牲小型震盪、強化大型破勢；命中有硬皮值的敵人時，追加其剩餘 HP 1% 的火屬性魔法傷害。" },
        ...
        "relic_blood_ritual_dagger":{ n: "血祭儀式短刀", type: "wpn", relic: true, noEnhance: true, dmgS: 7, dmgL: 7, hit: 15, dmgBonus: 12, prototypePolicy: { family: "匕首", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "royal,mage,elf", p: 10000, gachaWeight: 0, autocastBacklash: true, spellIgnoreMr: true, d: "【遺物】血色術士的獻祭短刀。犧牲小型貫穿、保留大型破勢；HP 大於 200 時，自動技能以等同 MP 消耗的固定自傷換取傷害魔法無視 MR。" },
        ...
        "relic_cold_blueflame":    { n: "凜冽的青色火炎", type: "wpn", chainsword: true, w2h: true, relic: true, noEnhance: true, dmgS: 26, dmgL: 26, hit: 16, dmgBonus: 18, req: "dragon", p: 10000, gachaWeight: 0, ignHardSkin: true, ele: "fire", slaughterHits: 5, slaughterRandom: true, prototypePolicy: { family: "鎖鏈劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, d: "【遺物】藍色火焰之靈魂凝成的鎖鏈劍。犧牲小型纏足、保留大型扯甲；弱點曝光、貫穿、火屬性與屠宰者五連擊維持不變。" },
        "relic_scorch_greatsword": { n: "烈炎燒灼的滾燙巨劍", type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 21, dmgL: 24, hit: 15, dmgBonus: 19, prototypePolicy: { family: "雙手劍", small: { mode: "enhance", changes: { every: 3, splashPct: 54, maxTargets: 2 } }, large: { mode: "sacrifice" } }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, ignHardSkin: true, ele: "fire", hardWear: 100, d: "【遺物】火焰烈炎獸的體溫燒灼的滾燙巨劍。強化對小型敵人的烈焰橫掃，犧牲大型震盪；攻擊為火屬性並額外削減 100 點硬皮值。" },
        ...
        "relic_bloodknight_dual":  { n: "嗜血騎士的雙刀", type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 18, dmgL: 12, hit: 18, dmgBonus: 14, req: "dark", p: 10000, gachaWeight: 0, eff: "combo", comboRate: 35, ignHardSkin: true, hpOnHit: 10, mpOnComboHit: 10, prototypePolicy: { family: "雙刀", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "【遺物】血騎士的嗜血雙刀。保留小型壓制、犧牲大型破勢；35%雙擊與命中恢復HP／MP維持不變。" },
        ...
        "relic_elmo_spear":        { n: "艾爾摩尖頭槍", type: "wpn", w2h: true, relic: true, noEnhance: true, eff: "pierce", pierceChance: 100, prototypePolicy: { family: "雙手矛", small: { mode: "enhance", changes: { chance: 35, splashPct: 40 } }, large: { mode: "sacrifice" } }, dmgS: 17, dmgL: 17, hit: 15, dmgBonus: 15, req: "royal,knight,elf,dragon,warrior", p: 10000, gachaWeight: 0, ignHardSkin: true, pierceMainMult: 1.3, d: "【遺物】受詛咒的艾爾摩士兵至死緊握的尖頭槍。強化對小型敵人的貫穿機率，犧牲大型破勢；一般攻擊只保留一項主目標傷害倍率（+30%）。" },
        ...
        "relic_crusher_hammer":    { n: "重裝戰士的粉碎鎚", type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 24, dmgL: 20, hit: 13, dmgBonus: 17, eff: "crush", prototypePolicy: { family: "雙手鈍器", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 3, durationTicks: 50 } } }, ignHardSkin: true, procInstakill: { p: 0.01, hardOnly: true, hasteSec: 8 }, req: "knight,illusion,warrior", p: 10000, gachaWeight: 0, d: "【遺物】重裝歐姆戰士的粉碎鎚。犧牲小型震盪、強化大型破勢；命中時 1% 使非頭目的硬皮怪立即死亡，觸發後攻速 +20% 持續 8 秒。" },
        ...
        "relic_maze_demon_glare":  { n: "迷宮惡魔的瞥視",     type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 22, dmgL: 24, hit: 14, dmgBonus: 14, eff: "crush", prototypePolicy: { family: "雙手鈍器", small: { mode: "enhance", changes: { delayTicks: 5, cooldownTicks: 30 } }, large: { mode: "sacrifice" } }, ignHardSkin: true, atkSpdPct: 30, missGrazeRate: 100, grazeDmgPct: 30, req: "royal,knight,illusion,dragon,warrior", p: 10000, gachaWeight: 0, d: "【遺物】迷宮惡魔的瞥視凝成的雙手鈍器。強化小型震盪、犧牲大型破勢；攻速 +30%，未命中改為造成 30% 傷害且不會爆擊的挫傷。" },
        ...
        "relic_steelmonk_staff":   { n: "鋼鐵僧侶的錫杖",     type: "wpn", w2h: true, isWand: true, relic: true, noEnhance: true, dmgS: 18, dmgL: 18, hit: 15, dmgBonus: 16, eff: "magicstrike", ignHardSkin: true, atkSpdPct: 30, str: 5, procHealSkill: { skId: "sk_regen", rate: 5 }, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 3, cooldownTicks: 40 } } }, req: "mage", p: 10000, gachaWeight: 0, d: "【遺物】祝禱與重擊並存的鋼鐵錫杖。犧牲小型施法干擾、強化大型震盪；攻速、力量與回復術維持不變。" },
        ...
        "relic_unsealed_baphomet_wand": { n: "解除封印的巴風特魔杖", type: "wpn", isWand: true, relic: true, noEnhance: true, dmgS: 7, dmgL: 6, hit: 20, dmgBonus: 17, ignHardSkin: true, mdmg: 3, extraMp: 3, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "keep" } }, procDualSkill: { skn: "熾焰地裂術", rate: 25, parts: [[4, 20, "earth"], [4, 20, "fire"]] }, req: "mage,illusion", p: 10000, gachaWeight: 0, d: "【遺物】掙脫封印的巴風特魔杖。犧牲小型施法干擾、保留大型震盪；共鳴、硬皮貫穿與25%熾焰地裂術維持不變。" },
        ...
        "relic_elmore_greatsword": { n: "艾爾摩古戰場巨劍",   type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 20, dmgL: 17, hit: 14, dmgBonus: 17, eff: "cleave", prototypePolicy: { family: "雙手劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, dblStrikeRate: 3, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】自艾爾摩古戰場出土的巨劍。保留掃蕩小型敵人的橫掃，犧牲大型震盪；一般攻擊仍有 3% 機率造成 2 倍傷害。" },
        "relic_warrior_blackblade":{ n: "戰士的漆黑之劍",     type: "wpn", relic: true, noEnhance: true, dmgS: 16, dmgL: 10, hit: 19, dmgBonus: 14, traumaProc: { pct: 5, dur: 6, maxStacks: 2, dmg: 5 }, prototypePolicy: { family: "單手劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】暗黑火焰戰士的漆黑之劍。保留小型橫掃、犧牲大型震盪；反擊、居合與創傷維持不變。" },
        ...
        "relic_beheading_scythe":  { n: "斬首的巨大鐮刀",     type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 21, dmgL: 26, hit: 13, dmgBonus: 13, eff: "cleave", prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, crushInstakill: { cdSec: 3, healHp: 30 }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】死神西斯的巨大鐮刀。犧牲橫掃、保留大型震盪；重擊時可斬首低等級非頭目（每 3 秒最多一次），觸發即死時恢復 30 HP。" },
        ...
        "relic_serrated_fangs":    { n: "無數鋸齒的邪惡利牙", type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 21, dmgL: 17, hit: 14, dmgBonus: 18, eff: "combo", comboRate: 25, comboForceCrit: true, critFuryHaste: { pct: 30, sec: 5 }, ignHardSkin: true, prototypePolicy: { family: "雙刀", small: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 40 } }, large: { mode: "sacrifice" } }, req: "dark", p: 10000, gachaWeight: 0, d: "【遺物】鋸齒獠牙鑄成的雙刀。強化小型壓制、犧牲大型破勢；雙擊必爆與爆擊加速維持不變。" },
        "relic_kurt_shield":       { n: "克特之盾",           type: "arm", slot: "shield", relic: true, noEnhance: true, ac: 13, block: 80, resWind: 5, judgmentThunder: { skn: "審判落雷", dice: [5, 20], flat: 60, ele: "wind", statusMagicHit: { kind: "paralyze", dur: 3 }, requireWpn: "wpn_kurt_sword" }, req: "royal,knight,dragon,elf", p: 10000, gachaWeight: 0, d: "【遺物】風之洞穴主人克特的巨盾，盾面仍迴盪著雷鳴。格檔 80（一般限定）；風屬性抗性 +5；當裝備克特之劍時，極道落雷變成審判落雷（更強大的風屬性單體傷害，並有機率使目標麻痺），且可使用「雷霆敕令」：32 秒內風屬性抗性 +15，審判落雷固定傷害加值再 +60。" },
        ...
        "relic_mageblade_knife":   { n: "專精劍術的魔劍士之刀", type: "wpn", relic: true, noEnhance: true, dmgS: 10, dmgL: 12, hit: 9, dmgBonus: 9, atkSpdPct: 30, spellbladeBuff: true, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "mage", p: 10000, gachaWeight: 0, d: "【遺物】劍鋒與咒文共鳴的魔劍士佩刀。犧牲小型橫掃、保留大型震盪；反擊、居合、攻速與魔劍增幅維持不變。" },
        ...
        "relic_true_dragonslayer": { n: "真‧屠龍劍",          type: "wpn", w2h: true, relic: true, noEnhance: true, dmgS: 37, dmgL: 45, hit: 17, dmgBonus: 30, eff: "cleave", prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 6, cooldownTicks: 30 } } }, ignHardSkin: true, mcrit: 3, dragonSlayStrike: { rate: 15, dice: 5, flat: 60, dragonMult: 3 }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】甦醒龍魂的屠龍劍真身。犧牲橫掃並強化大型震盪；爆擊率 +3%，攻擊時 15% 觸發滅龍的一擊，對全體造成依力量、敏捷、體質而定的無視防禦固定傷害，對龍造成 3 倍。" },
        "relic_flame_dk_sword":    { n: "烈焰的死亡騎士之劍", type: "wpn", relic: true, noEnhance: true, dmgS: 25, dmgL: 25, hit: 15, dmgBonus: 25, ele: "fire", ignHardSkin: true, flameDkMorph: true, procRateBase: 25, procRatePerEn: 0, spellProc: { skn: "煉獄火", dice: [16, 10], flat: 80, ele: "fire", aoe: true, burnDot: { dmg: 30, dur: 6 } }, procBurn: { magicHit: true, dmg: 30, dur: 6 }, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "sacrifice" } }, req: "royal,knight,dragon", p: 10000, gachaWeight: 0, d: "【遺物】烈焰死亡騎士的佩劍。小型橫掃與大型震盪皆犧牲，力量集中於變身、煉獄火與持續灼燒。" },
        ...
        "wpn_crimson_xbow": { n: "深紅之弩", type: "wpn", isBow: true, ranged: true, rapidfire: 80, w2h: true, dmgS: 3, dmgL: 3, hit: 1, dmgBonus: 0, req: "elf", safe: 6, p: 56000, gachaWeight: 0, prototypePolicy: { family: "十字弓", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 30 } } }, procStatus: { kind: "bind", rate: 2, dur: 6 }, d: "染上龍血的深紅十字弓。犧牲小型穿甲破勢、強化大型震盪；原有2%束縛仍獨立判定。" },   // 🕸️ v3.7.75 依規格重寫（原 5/4·命中+5·傷害+5·連射70·妖精+黑妖·15萬）：連射80(一般限定)＋攻擊時 2% 束縛 6 秒（成敗仍看魔法命中／目標魔抗·頭目免疫）
        ...
        "wpn_giltas_sword":  { n: "吉爾塔斯之劍", type: "wpn", w2h: true, legend: true, dmgS: 43, dmgL: 53, hit: 7, dmgBonus: 30, spd: 1, req: "knight,dragon", safe: 0, p: 990000, gachaWeight: 0, eff: "cleave", ignHardSkin: true, str: 2, con: 1, cha: 2, prototypePolicy: { family: "雙手劍", small: { mode: "sacrifice" }, large: { mode: "replace", mechanic: { effect: "break_stance", defense: 2, durationTicks: 50 } } }, d: "吉爾塔斯魔力凝成的雙手魔劍。犧牲小型橫掃，將大型震盪替換為破勢；切割、貫穿、屬性與邪惡擊殺加成維持不變。" },
"wpn_giltas_wand":   { n: "吉爾塔斯魔杖", type: "wpn", w2h: true, legend: true, dmgS: 15, dmgL: 15, hit: 0, dmgBonus: 0, spd: 1.0, req: "mage,illusion", safe: 0, p: 990000, gachaWeight: 0, eff: "magicburst", int: 2, wis: 2, mpR: 15, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 3, cooldownTicks: 40 } } }, d: "吉爾塔斯魔力凝成的雙手魔杖。犧牲小型施法干擾、強化大型震盪；魔爆、硬皮貫穿與擊殺後魔力增幅維持不變。" },
        "wpn_rotten_longbow":{ n: "腐壞的長弓", type: "wpn", w2h: true, isBow: true, ranged: true, legend: true, dmgS: 5, dmgL: 4, hit: 7, dmgBonus: 5, rapidfire: 100, ignHardSkin: true, prototypePolicy: { family: "弓", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 30 } } }, req: "elf,illusion", safe: 6, p: 850000, gachaWeight: 1, d: "在聖地深處腐朽多年的長弓。犧牲小型牽制、強化大型破勢；連射100%仍是唯一主要追加傷害來源，不再額外疊加貫穿。" },
        "wpn_cursed_emperor_blade": { n: "受詛咒的真．冥皇執行劍", type: "wpn", legend: true, dmgS: 19, dmgL: 22, hit: 4, dmgBonus: 0, spd: 1, ignHardSkin: true, hpR: -30, req: "royal,knight,elf,mage,dark", safe: 6, p: 990000, gachaWeight: 0, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, d: "冥皇詛咒滲入的漆黑執行劍。犧牲小型橫掃、保留大型震盪；反擊、居合、貫穿、負恢復與死亡騎士變身維持不變。" },   // 🌑 v3.4.0 裝備時變身死亡騎士＝js/02 _setPoly 管線；反擊+居合＝WEAPON_TAGS 雙標籤（js/10）
        ...
        "wpn_crimson_spear": { n: "深紅長矛", type: "wpn", w2h: true, dmgS: 21, dmgL: 21, hit: 1, dmgBonus: 0, spd: 1.1, req: "knight", safe: 6, p: 89000, gachaWeight: 1, eff: "pierce", pierceChance: 80, prototypePolicy: { family: "雙手矛", small: { mode: "keep" }, large: { mode: "sacrifice" } }, unBonus: true, mhp: 50, d: "矛身被無數鮮血浸透成暗紅；保留對小型敵人的貫穿，以大型破勢換取不死剋制與生命力。" },
        "wpn_frost_spear": { n: "酷寒之矛", type: "wpn", dmgS: 15, dmgL: 15, hit: 0, dmgBonus: 1, spd: 1.1, req: "royal,knight,elf,warrior", safe: 6, p: 185000, gachaWeight: 1, prototypePolicy: { family: "單手矛", small: { mode: "keep" }, large: { mode: "sacrifice" } }, spellProc: { skn: "寒冰追擊", dice: [4, 30], ele: "water" }, procRateBase: 1, procRatePerEn: 1, d: "矛身凝著永不消融的寒霜。保留小型貫穿、犧牲大型破勢，攻擊可觸發水屬性寒冰追擊。" },   // 🧊 單手矛（矛 tag→出血・一般限定）；v3.2.1 用戶：移除 noMagicDmg → 觸發傷害吃魔法傷害加成
        "wpn_thunder_sword": { n: "雷雨之劍", type: "wpn", dmgS: 13, dmgL: 12, hit: 1, dmgBonus: 1, spd: 0.9, req: "royal,knight,elf,dark,dragon", safe: 6, p: 185000, gachaWeight: 1, prototypePolicy: { family: "單手劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, spellProc: { skn: "雷擊", dice: [4, 30], ele: "wind" }, procRateBase: 1, procRatePerEn: 1, d: "劍身間遊走著被封入的雷霆。保留小型橫掃、犧牲大型震盪，攻擊可觸發風屬性雷擊。" },   // ⚡ 單手劍（單手劍 tag→反擊・一般限定）；v3.2.1 用戶：移除 noMagicDmg → 觸發傷害吃魔法傷害加成
        ...
        "wpn_hate_claw": { n: "恨之鋼爪", type: "wpn", w2h: true, dmgS: 26, dmgL: 15, hit: 2, dmgBonus: 5, spd: 0.9, req: "dark", safe: 0, p: 10000, gachaWeight: 20, eff: "combo", comboRate: 50, prototypePolicy: { family: "鋼爪", small: { mode: "enhance", changes: { defense: 2, durationTicks: 30 } }, large: { mode: "sacrifice" } }, d: "由純粹恨意鍛成的鋼爪。強化小型撕甲、犧牲大型牽扯；50%雙擊維持不變。" },
        "wpn_demon_sword": { n: "惡魔之劍", type: "wpn", dmgS: 17, dmgL: 9, hit: 4, dmgBonus: 0, spd: 0.9, req: "knight,elf", safe: 6, p: 50000, gachaWeight: 1, eff: "haste", prototypePolicy: { family: "單手劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "惡魔親手淬煉的單手劍。保留小型橫掃、犧牲大型震盪；反擊與裝備加速維持不變。" },
        "wpn_demon_dual": { n: "惡魔雙刀", type: "wpn", w2h: true, dmgS: 18, dmgL: 13, hit: 4, dmgBonus: 3, spd: 0.8, req: "dark", safe: 6, p: 50000, gachaWeight: 1, eff: "combo", equipHaste: true, prototypePolicy: { family: "雙刀", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "自惡魔利爪幻化的雙刀。保留小型壓制、犧牲大型破勢；雙擊與裝備加速維持不變。" },
        "wpn_demon_claw": { n: "惡魔鋼爪", type: "wpn", w2h: true, dmgS: 20, dmgL: 18, hit: 0, dmgBonus: 3, spd: 0.9, req: "dark", safe: 6, p: 50000, gachaWeight: 1, eff: "combo", equipHaste: true, prototypePolicy: { family: "鋼爪", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "惡魔指骨淬煉的鋼爪。保留小型撕甲、犧牲大型牽扯；雙擊與裝備加速維持不變。" },
        "wpn_dual_destroy": { n: "破壞雙刀", type: "wpn", w2h: true, dmgS: 16, dmgL: 10, hit: 6, dmgBonus: 1, str: 1, wis: 2, spd: 0.8, req: "dark", safe: 6, p: 150000, legend: true, gachaWeight: 1, eff: "combo", comboRate: 30, prototypePolicy: { family: "雙刀", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 40 } } }, procBurstPoison: { rateBase: 1, ratePerEn: 1 }, d: "蘊含猛爆毒性的漆黑雙刃。犧牲小型壓制、強化大型破勢；雙擊與猛爆劇毒維持不變。" },
        "wpn_claw_destroy": { n: "破壞鋼爪", type: "wpn", w2h: true, dmgS: 19, dmgL: 18, hit: 6, dmgBonus: 1, str: 1, wis: 2, spd: 0.9, req: "dark", safe: 6, p: 150000, legend: true, gachaWeight: 1, eff: "combo", comboRate: 30, prototypePolicy: { family: "鋼爪", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 5, cooldownTicks: 40 } } }, procBurstPoison: { rateBase: 1, ratePerEn: 1 }, d: "凝聚猛爆毒性的漆黑利爪。犧牲小型撕甲、強化大型牽扯；雙擊與猛爆劇毒維持不變。" },
        "wpn_demon_xbow": { n: "惡魔十字弓", type: "wpn", isBow: true, ranged: true, rapidfire: 60, w2h: true, dmgS: 3, dmgL: 3, hit: 2, dmgBonus: 4, spd: 1.0, req: "elf", safe: 6, p: 47300, gachaWeight: 1, equipHaste: true, prototypePolicy: { family: "十字弓", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "以惡魔之骨為弦的十字弓。保留小型穿甲破勢、犧牲大型震盪，裝備加速與連射維持不變。" },
        "wpn_powerless_baphomet": { n: "失去魔力的巴風特魔杖", type: "wpn", dmgS: 1, dmgL: 1, hit: 0, dmgBonus: 0, spd: 1.0, req: "all", safe: 6, p: 100000, gachaWeight: 0, noEnhance: true, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "sacrifice" } }, d: "曾屬於巴風特、如今魔力枯竭的魔杖。封印狀態犧牲小型施法干擾與大型震盪；使用靈魂之球解封後才恢復正式魔杖原型。無法強化，可販售。" },   // 🏛️ noEnhance＝封印恆 +0（傳統模式自帶強化值延後到靈魂之球解封印時附加）
        "wpn_baphomet_wand": { n: "巴風特魔杖", type: "wpn", dmgS: 7, dmgL: 6, hit: 8, dmgBonus: 5, spd: 1.0, req: "mage", safe: 0, p: 210000, legend: true, gachaWeight: 1, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "keep" } }, procSkill: "sk_earthquake", procRateBase: 8, procRatePerEn: 2, mdmgEnFrom7Max3: true, d: "魔神巴風特之力甦醒的魔杖。犧牲小型施法干擾、保留大型震盪，大地撕裂觸發維持不變。" },
        "wpn_qigu_obsidian": { n: "黑曜石奇古獸", type: "wpn", qigu: true, dmgS: 24, dmgL: 24, hit: 0, spd: 0.8, mdmg: 1, wis: 1, sizeMechanics: { small: { effect: "stagger", delayTicks: 2, cooldownTicks: 50 }, large: { effect: "focus", mp: 1, cooldownTicks: 40 } }, req: "illusion", safe: 6, p: 100000, gachaWeight: 10, d: "幻術士豢養的基礎奇古獸。對小型施加幻壓、對大型命中回靈；必中魔法維持原有判定。" },
        "wpn_qigu_meditate": { n: "冥想奇古獸", type: "wpn", qigu: true, dmgS: 25, dmgL: 25, hit: 0, spd: 0.8, wis: 1, mpR: 5, mpRPerEn: 1, prototypePolicy: { family: "奇古獸", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { mp: 2, cooldownTicks: 40 } } }, req: "illusion", safe: 6, p: 100000, gachaWeight: 10, d: "沉入冥想的奇古獸。犧牲小型幻壓、強化大型回靈；既有魔力恢復維持不變。" },
        "wpn_qigu_resonance": { n: "共鳴奇古獸", type: "wpn", qigu: true, dmgS: 25, dmgL: 25, hit: 0, spd: 0.8, mdmg: 1, wis: 3, qiguProc: "phantom", prototypePolicy: { family: "奇古獸", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "illusion", safe: 6, p: 300000, gachaWeight: 1, d: "與持有者心神共鳴的奇古獸。保留小型幻壓、犧牲大型回靈；幻影衝擊維持不變。" },
        "wpn_qigu_frost": { n: "寒冰奇古獸", type: "wpn", qigu: true, dmgS: 25, dmgL: 25, hit: 0, spd: 0.8, mdmg: 1, int: 1, qiguProc: "mindbreak", prototypePolicy: { family: "奇古獸", small: { mode: "enhance", changes: { delayTicks: 3, cooldownTicks: 50 } }, large: { mode: "sacrifice" } }, req: "illusion", safe: 6, p: 300000, gachaWeight: 1, d: "凝著寒霜的奇古獸。強化小型幻壓、犧牲大型回靈；心靈破壞維持不變。" },
        "wpn_qigu_sapphire": { n: "藍寶石奇古獸", type: "wpn", qigu: true, dmgS: 26, dmgL: 26, hit: 0, spd: 0.8, mpR: 10, prototypePolicy: { family: "奇古獸", small: { mode: "sacrifice" }, large: { mode: "keep" } }, req: "illusion", safe: 6, p: 10000, gachaWeight: 20, d: "通體湛藍如海的奇古獸。犧牲小型幻壓、保留大型回靈；既有魔力恢復維持不變。" },
        ...
        "wpn_chain_annihilator": { n: "消滅者鎖鏈劍", type: "wpn", w2h: true, chainsword: true, weakExpose: true, unBonus: true, dmgS: 17, dmgL: 13, hit: 5, dmgBonus: 3, spd: 0.9, sizeMechanics: { small: { effect: "stagger", delayTicks: 3, cooldownTicks: 40 }, large: { effect: "break_stance", defense: 1, durationTicks: 40 } }, req: "dragon", safe: 6, p: 10000, gachaWeight: 20, d: "龍騎士的基礎鎖鏈巨劍。對小型纏足、對大型扯甲；弱點曝光維持原有判定。" },
        "wpn_chain_destroyer": { n: "破滅者鎖鏈劍", type: "wpn", w2h: true, chainsword: true, weakExpose: true, str: 1, dmgS: 21, dmgL: 17, hit: 5, dmgBonus: 3, spd: 0.9, prototypePolicy: { family: "鎖鏈劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "dragon", safe: 6, p: 88000, gachaWeight: 30, d: "以毀滅為名的鎖鏈劍。保留小型纏足、犧牲大型扯甲；弱點曝光維持不變。" },
        "wpn_chain_bloodthirst": { n: "嗜血者鎖鏈劍", type: "wpn", w2h: true, chainsword: true, weakExpose: true, vampPct: 0.05, dmgS: 21, dmgL: 20, hit: 5, dmgBonus: 3, spd: 0.9, prototypePolicy: { family: "鎖鏈劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 40 } } }, req: "dragon", safe: 6, p: 138000, gachaWeight: 1, d: "渴飲鮮血的鎖鏈劍。犧牲小型纏足、強化大型扯甲；弱點曝光與吸血維持不變。" },
        "wpn_chain_resonance": { n: "共鳴鎖鏈劍", type: "wpn", w2h: true, chainsword: true, weakExpose: true, str: 1, wis: 2, dmgS: 21, dmgL: 20, hit: 6, dmgBonus: 3, spd: 0.9, prototypePolicy: { family: "鎖鏈劍", small: { mode: "keep" }, large: { mode: "sacrifice" } }, req: "dragon", safe: 6, p: 164000, gachaWeight: 1, spellProc: { skn: "共鳴衝擊", dice: [4, 8], ele: "water" }, procRateBase: 1, procRatePerEn: 1, d: "鎖鏈之中迴盪著水之共鳴。保留小型纏足、犧牲大型扯甲；弱點曝光與共鳴衝擊維持不變。" },
        "wpn_chain_frost": { n: "寒冰鎖鏈劍", type: "wpn", w2h: true, chainsword: true, weakExpose: true, dmgS: 24, dmgL: 20, hit: 4, dmgBonus: 3, spd: 0.9, prototypePolicy: { family: "鎖鏈劍", small: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 40 } }, large: { mode: "sacrifice" } }, req: "dragon", safe: 6, p: 324000, gachaWeight: 1, spellProc: { skn: "冰之地裂術", dice: [8, 4], ele: "water", heal: 0.2 }, procRateBase: 1, procRatePerEn: 1, d: "凍結寒氣纏繞的鎖鏈劍。強化小型纏足、犧牲大型扯甲；弱點曝光、冰之地裂術與治療維持不變。" },
        ...
        "wpn_iron_axehead": { n: "鐵斧頭", type: "wpn", dmgS: 19, dmgL: 23, hit: 1, dmgBonus: 1, spd: 0.9, req: "warrior", safe: 6, p: 155000, gachaWeight: 1, prototypePolicy: { family: "單手鈍器", small: { mode: "sacrifice" }, large: { mode: "keep" } }, d: "精鐵反覆鍛打而成的斧頭。犧牲小型震盪、保留大型破勢；單手鈍擊與戰士雙持維持不變。" },
        "wpn_giant_axehead": { n: "巨人的斧頭", type: "wpn", legend: true, dmgS: 28, dmgL: 36, hit: 2, dmgBonus: 5, spd: 0.9, req: "warrior", safe: 6, p: 355000, gachaWeight: 1, prototypePolicy: { family: "單手鈍器", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { defense: 2, durationTicks: 40 } } }, d: "昔日巨人揮舞的巨大斧頭。犧牲小型震盪、強化大型破勢；單手鈍擊與戰士雙持維持不變。" },
        ...
        "wpn_redflame_bow": { n: "赤焰之弓", type: "wpn", isBow: true, ranged: true, rapidfire: 70, w2h: true, dmgS: 3, dmgL: 3, hit: 2, dmgBonus: 4, spd: 1.0, req: "elf", safe: 6, p: 10000, gachaWeight: 20, prototypePolicy: { family: "弓", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "灌注炎魔之力的長弓。保留對小型敵人的牽制射擊、犧牲大型破勢，避免與連射疊出額外倍率。" },
        ...
        "wpn_death_finger": { n: "死亡之指", type: "wpn", w2h: true, dmgS: 17, dmgL: 15, hit: 3, dmgBonus: 2, spd: 0.9, req: "dark", safe: 6, p: 10000, gachaWeight: 20, eff: "combo", comboRate: 20, prototypePolicy: { family: "鋼爪", small: { mode: "enhance", changes: { defense: 2, durationTicks: 30 } }, large: { mode: "sacrifice" } }, procPoison: { rate: 2, dur: 15, tick: 3, dmg: [1, 8] }, d: "墮落之力凝成的枯瘦指爪。強化小型撕甲、犧牲大型牽扯；腐毒與雙擊維持不變。" },
        // ===== 🌑 暗影神殿：材料 / 鑰匙 =====
        ...
        "wpn_demonking_spear": { n: "惡魔王矛", type: "wpn", w2h: true, dmgS: 25, dmgL: 25, hit: 2, dmgBonus: 3, spd: 1.1, req: "knight", safe: 6, p: 380000, legend: true, gachaWeight: 1, eff: "pierce", pierceChance: 90, prototypePolicy: { family: "雙手矛", small: { mode: "keep" }, large: { mode: "replace", mechanic: { effect: "stagger", delayTicks: 5, cooldownTicks: 30 } } }, procStatusSkill: { skId: "sk_disease", rate: 10 }, d: "惡魔王執掌的雙手長矛；保留貫穿，對大型敵人的破勢被瘟疫震盪取代。" },
        "wpn_demonking_dual": { n: "惡魔王雙刀", type: "wpn", w2h: true, dmgS: 18, dmgL: 16, hit: 5, dmgBonus: 3, spd: 0.8, req: "dark", safe: 6, p: 420000, legend: true, gachaWeight: 1, eff: "combo", prototypePolicy: { family: "雙刀", small: { mode: "sacrifice" }, large: { mode: "keep" } }, procStatusSkill: { skId: "sk_disease", rate: 10 }, d: "惡魔王手中的雙刀。犧牲小型壓制、保留大型交叉破勢；雙擊與病厄觸發維持不變。" },
        "wpn_demonking_2hsword": { n: "惡魔王雙手劍", type: "wpn", w2h: true, dmgS: 23, dmgL: 24, hit: 1, dmgBonus: 5, spd: 0.9, req: "knight", safe: 6, p: 354510, legend: true, gachaWeight: 1, eff: "cleave", prototypePolicy: { family: "雙手劍", small: { mode: "keep" }, large: { mode: "replace", mechanic: { effect: "break_stance", defense: 2, durationTicks: 50 } } }, procStatusSkill: { skId: "sk_disease", rate: 10 }, d: "惡魔王曾以此巨劍劈開無數生靈；保留橫掃，將大型震盪替換為瘟疫破勢。" },
        "wpn_demonking_wand": { n: "惡魔王魔杖", type: "wpn", w2h: true, dmgS: 12, dmgL: 12, hit: 6, dmgBonus: 2, spd: 1.0, req: "mage", safe: 6, p: 494510, legend: true, gachaWeight: 1, eff: "magicburst", mdmg: 2, mpR: 10, mpOnHit: true, prototypePolicy: { family: "魔杖", small: { mode: "keep" }, large: { mode: "sacrifice" } }, procStatusSkill: { skId: "sk_disease", rate: 10 }, d: "惡魔王施法用的雙手魔杖。保留小型施法干擾、犧牲大型震盪；魔爆、回魔與瘟疫維持不變。" },
        "wpn_demonking_bow": { n: "惡魔王弓", type: "wpn", isBow: true, ranged: true, rapidfire: 90, w2h: true, dmgS: 5, dmgL: 5, hit: 4, dmgBonus: 6, spd: 1.0, req: "elf", safe: 6, p: 547300, legend: true, gachaWeight: 1, prototypePolicy: { family: "弓", small: { mode: "sacrifice" }, large: { mode: "keep" } }, procStatusSkill: { skId: "sk_disease", rate: 10 }, d: "惡魔王的長弓。犧牲小型牽制、保留大型破勢，射出的箭仍有機率附帶瘟疫詛咒。" },
        // ===== 🏝️ 遺忘之島：武器 =====
        ...
        "wpn_shaha_bow": { n: "沙哈之弓", type: "wpn", isBow: true, ranged: true, w2h: true, legend: true, rapidfire: 70, dmgS: 4, dmgL: 4, hit: 2, dmgBonus: 5, spd: 1.0, req: "elf", safe: 6, p: 230000, gachaWeight: 0, shahaBow: true, prototypePolicy: { family: "弓", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "傳說中神射手沙哈所遺的名弓。保留小型牽制、犧牲大型破勢，仍可憑風凝成取之不竭的沙哈之箭。" },
        ...
        "wpn_old_sword": { n: "古老的劍", type: "wpn", dmgS: 35, dmgL: 20, hit: 5, dmgBonus: 0, spd: 0.8, req: "knight,elf,dark", safe: 0, p: 15000, gachaWeight: 0, noEnhance: true, prototypePolicy: { family: "單手劍", small: { mode: "enhance", changes: { every: 4, splashPct: 50, maxTargets: 1 } }, large: { mode: "sacrifice" } }, d: "塵封已久的古代單手劍。強化小型橫掃、犧牲大型震盪；反擊、居合、不可強化與特殊屬性賦予維持不變。" },
        "wpn_old_greatsword": { n: "古老的巨劍", type: "wpn", w2h: true, dmgS: 27, dmgL: 45, hit: 3, dmgBonus: 3, spd: 0.9, req: "knight", safe: 0, p: 15000, gachaWeight: 0, eff: "cleave", prototypePolicy: { family: "雙手劍", small: { mode: "enhance", changes: { every: 3, splashPct: 54, maxTargets: 2 } }, large: { mode: "sacrifice" } }, noEnhance: true, d: "古老戰場上遺落的雙手巨劍。強化對小型敵人的橫掃、犧牲大型震盪；無法強化，但可請碧恩直接賦予最高第五階屬性。" },
        "wpn_old_xbow": { n: "古老的弩槍", type: "wpn", isBow: true, ranged: true, oneHand: true, rapidfire: 90, dmgS: 3, dmgL: 3, hit: 5, dmgBonus: 2, spd: 0.9, req: "elf,dark", safe: 6, p: 15000, gachaWeight: 0, prototypePolicy: { family: "十字弓", small: { mode: "sacrifice" }, large: { mode: "keep" } }, d: "古代工匠巧製的單手弩槍。犧牲小型穿甲破勢、保留大型震盪，維持可搭配副手的古代結構。" },
        "wpn_ancient_spear": { n: "古代神之槍", type: "wpn", w2h: true, legend: true, dmgS: 27, dmgL: 30, hit: 3, dmgBonus: 5, spd: 1.1, req: "knight", safe: 6, p: 465000, gachaWeight: 0, eff: "pierce", pierceChance: 90, prototypePolicy: { family: "雙手矛", small: { mode: "keep" }, large: { mode: "enhance", changes: { defense: 3, durationTicks: 50 } } }, d: "傳說由古代神祇親手持握的雙手神槍；保留貫穿，並將對大型敵人的破勢強化至最高原型預算。" },
        "wpn_ancient_axe": { n: "古代神之斧", type: "wpn", legend: true, dmgS: 25, dmgL: 28, hit: 3, dmgBonus: 8, spd: 1, req: "warrior", safe: 6, p: 465000, gachaWeight: 0, prototypePolicy: { family: "單手鈍器", small: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 30 } }, large: { mode: "sacrifice" } }, d: "古代神祇腰間配掛的單手神斧。強化小型震盪、犧牲大型破勢；單手鈍擊與戰士雙持維持不變。" },
        "wpn_ancient_darkelf_sword": { n: "古代黑暗妖精之劍", type: "wpn", dmgS: 12, dmgL: 12, hit: 3, dmgBonus: 1, spd: 0.9, req: "elf", safe: 6, p: 68000, gachaWeight: 1, unBonus: true, dex: 1, mhp: 50, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, d: "古代黑暗妖精所執的單手劍。犧牲小型橫掃、保留大型震盪；反擊、不死加成、敏捷與生命維持不變。" },
        "wpn_ancient_elf_xbow": { n: "古代妖精弩槍", type: "wpn", isBow: true, ranged: true, oneHand: true, rapidfire: 55, dmgS: 3, dmgL: 3, hit: 1, dmgBonus: 2, spd: 1.0, req: "elf", safe: 6, p: 68000, gachaWeight: 1, dex: 1, prototypePolicy: { family: "十字弓", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "古代妖精打造的單手弩槍。保留小型穿甲破勢、犧牲大型震盪，維持輕巧迅捷與敏捷加成。" },
        // ===== 👹 隱藏的魔族武器（說話之島 尤麗婭以 黑暗哈汀的日記本 六選一兌換；紅惡靈逆襲＝水魔傷+吸HP / 藍惡靈奪魔＝回MP，4%+每強化1%） =====
        "wpn_demon_sword_hidden": { n: "隱藏的魔族之劍", type: "wpn", dmgS: 23, dmgL: 25, hit: 3, dmgBonus: 0, spd: 0.9, req: "royal,knight,elf,dragon", safe: 0, p: 28000, gachaWeight: 1, mhp: 30, ignHardSkin: true, redSpecter: true, prototypePolicy: { family: "單手劍", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 4, cooldownTicks: 30 } } }, d: "潛藏魔族之力的單手劍。犧牲小型橫掃、強化大型震盪；反擊、貫穿、生命與赤紅惡靈維持不變。" },
        "wpn_demon_bow_hidden": { n: "隱藏的魔族弓箭", type: "wpn", isBow: true, ranged: true, oneHand: true, rapidfire: 70, dmgS: 2, dmgL: 2, hit: 3, dmgBonus: 6, spd: 1.0, req: "royal,mage,elf,illusion", safe: 0, p: 28000, gachaWeight: 1, blueSpecter: true, prototypePolicy: { family: "弓", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "潛藏魔族之力的單手弓。保留小型牽制、犧牲大型破勢，湛藍惡靈能力維持原有判定。" },
        "wpn_demon_wand_hidden": { n: "隱藏的魔族魔杖", type: "wpn", dmgS: 15, dmgL: 16, hit: 3, dmgBonus: 0, spd: 1.0, mdmg: 1, mpR: 3, req: "mage,illusion", safe: 0, p: 28000, gachaWeight: 1, blueSpecter: true, prototypePolicy: { family: "魔杖", small: { mode: "sacrifice" }, large: { mode: "enhance", changes: { delayTicks: 3, cooldownTicks: 40 } } }, d: "潛藏魔族之力的魔杖。犧牲小型施法干擾、強化大型震盪；魔法傷害、回魔、共鳴與湛藍惡靈維持不變。" },
        "wpn_demon_claw_hidden": { n: "隱藏的魔族鋼爪", type: "wpn", w2h: true, dmgS: 24, dmgL: 26, hit: 3, dmgBonus: 0, spd: 0.9, eff: "combo", comboRate: 33, req: "dark", safe: 0, p: 28000, gachaWeight: 1, redSpecter: true, prototypePolicy: { family: "鋼爪", small: { mode: "sacrifice" }, large: { mode: "keep" } }, d: "潛藏魔族之力的雙手鋼爪。犧牲小型撕甲、保留大型牽扯；雙擊與赤紅惡靈維持不變。" },
        "wpn_demon_chain_hidden": { n: "隱藏的魔族鎖鏈劍", type: "wpn", w2h: true, chainsword: true, weakExpose: true, dmgS: 25, dmgL: 26, hit: 3, dmgBonus: 0, spd: 0.9, req: "dragon", safe: 0, p: 28000, gachaWeight: 1, redSpecter: true, prototypePolicy: { family: "鎖鏈劍", small: { mode: "sacrifice" }, large: { mode: "keep" } }, d: "潛藏魔族之力的雙手鎖鏈劍。犧牲小型纏足、保留大型扯甲；弱點曝光與赤紅惡靈維持不變。" },
        "wpn_demon_qigu_hidden": { n: "隱藏的魔族奇古獸", type: "wpn", qigu: true, dmgS: 28, dmgL: 28, hit: 3, dmgBonus: 0, spd: 1.0, mdmg: 1, mpR: 1, req: "illusion", safe: 0, p: 28000, gachaWeight: 1, blueSpecter: true, prototypePolicy: { family: "奇古獸", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "潛藏魔族之力的奇古獸。保留小型幻壓、犧牲大型回靈；必中魔法與湛藍惡靈維持不變。" },
        ...
        "wpn_dark_crystalball": { n: "漆黑水晶球", type: "wpn", dmgS: 1, dmgL: 1, hit: 0, spd: 1.0, req: "mage,illusion", safe: 6, p: 20000, gachaWeight: 1, mdmg: 1, cha: 2, ignHardSkin: true, prototypePolicy: { family: "魔杖", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "凝聚漆黑魔力的水晶球。保留小型施法干擾、犧牲大型震盪；魔法傷害、魅力、貫穿與共鳴維持不變。" },
        "wpn_silent_crossbow": { n: "寂靜十字弓", type: "wpn", ranged: true, isBow: true, oneHand: true, dmgS: 3, dmgL: 2, hit: 1, dmgBonus: 1, spd: 1.0, req: "elf,illusion", safe: 6, p: 15000, gachaWeight: 30, rapidfire: 50, prototypePolicy: { family: "十字弓", small: { mode: "keep" }, large: { mode: "sacrifice" } }, d: "無聲扣動的單手十字弓。保留小型穿甲破勢、犧牲大型震盪，連發仍如疾雨。" },
        // ===== 🏴‍☠️ 海賊島 防具 =====
        ...
        "acc_icequeen_ear_8_str": { n: "冰之女王的耳環 Lv8 力量", type: "acc", slot: "ear", legend: true, ac: 0, req: "all", safe: 0, p: 100000, gachaWeight: 0, mhp: 20, mmp: 10, hpR: 2, mpR: 1, str: 1, grantSkills: ["sk_icequeen_veil"], grantSkillsEquipOnly: true, d: "冰之女王耳環的至高型態（力量）。裝備後可使用「寒晶護幕」：32 秒內水屬性抗性 +20、受到的所有傷害 −20%。" },
        "acc_icequeen_ear_8_dex": { n: "冰之女王的耳環 Lv8 敏捷", type: "acc", slot: "ear", legend: true, ac: 0, req: "all", safe: 0, p: 100000, gachaWeight: 0, mhp: 20, mmp: 10, hpR: 2, mpR: 1, dex: 1, grantSkills: ["sk_icequeen_veil"], grantSkillsEquipOnly: true, d: "冰之女王耳環的至高型態（敏捷）。裝備後可使用「寒晶護幕」：32 秒內水屬性抗性 +20、受到的所有傷害 −20%。" },
        "acc_icequeen_ear_8_int": { n: "冰之女王的耳環 Lv8 智力", type: "acc", slot: "ear", legend: true, ac: 0, req: "all", safe: 0, p: 100000, gachaWeight: 0, mhp: 20, mmp: 10, hpR: 2, mpR: 1, int: 1, grantSkills: ["sk_icequeen_veil"], grantSkillsEquipOnly: true, d: "冰之女王耳環的至高型態（智力）。裝備後可使用「寒晶護幕」：32 秒內水屬性抗性 +20、受到的所有傷害 −20%。" },
        "acc_icequeen_ear_8_con": { n: "冰之女王的耳環 Lv8 體質", type: "acc", slot: "ear", legend: true, ac: 0, req: "all", safe: 0, p: 100000, gachaWeight: 0, mhp: 20, mmp: 10, hpR: 2, mpR: 1, con: 1, grantSkills: ["sk_icequeen_veil"], grantSkillsEquipOnly: true, d: "冰之女王耳環的至高型態（體質）。裝備後可使用「寒晶護幕」：32 秒內水屬性抗性 +20、受到的所有傷害 −20%。" },
        "acc_icequeen_ear_8_wis": { n: "冰之女王的耳環 Lv8 精神", type: "acc", slot: "ear", legend: true, ac: 0, req: "all", safe: 0, p: 100000, gachaWeight: 0, mhp: 20, mmp: 10, hpR: 2, mpR: 1, wis: 1, grantSkills: ["sk_icequeen_veil"], grantSkillsEquipOnly: true, d: "冰之女王耳環的至高型態（精神）。裝備後可使用「寒晶護幕」：32 秒內水屬性抗性 +20、受到的所有傷害 −20%。" },
        "acc_icequeen_ear_8_cha": { n: "冰之女王的耳環 Lv8 魅力", type: "acc", slot: "ear", legend: true, ac: 0, req: "all", safe: 0, p: 100000, gachaWeight: 0, mhp: 20, mmp: 10, hpR: 2, mpR: 1, cha: 1, grantSkills: ["sk_icequeen_veil"], grantSkillsEquipOnly: true, d: "冰之女王耳環的至高型態（魅力）。裝備後可使用「寒晶護幕」：32 秒內水屬性抗性 +20、受到的所有傷害 −20%。" },
        // ===== 🏴‍☠️ 海賊島 受詛咒戒指 =====
    ...
    towns: {
		...
		"town_ivory_tower": {
            ...
            npcs: [
                ...
                { id: "npc_mystic_mage", n: "神秘的魔法師", title: "魔杖與火炬", type: "craft", d: "不願透露姓名的魔法師，除了以鋼鐵重鑄法器，也能將恐懼、憎恨與毀滅三把鑰匙合成未鑑定的地獄火炬。" }
            ]
        },
        "town_witon": {
            n: "威頓村",
	...
	skills: {
        ...
        "sk_fireball_burst": { n: "爆裂的火球", type: "atk", tier: 4, mp: 20, dmgType: "magic", ele: "fire", target: "all", dmgDice: [6, 10], originClasses: ["mage", "elf"] },   // 🏺 遺物「烈焰巫師的正式長袍」：已學燃燒的火球時，於施法瞬間替換（castSkillInner→_fireballMorphId·js/07；傭兵鏡像 js/06）；特效由 js/09 SPELL_FX 直接註冊「爆裂的火球」；非可學技能
        ...
        // ❄️👑 冰之女王耳環 Lv8 六型態專屬裝備技能：無技能書、只能在裝備期間取得。
        "sk_icequeen_veil": { n: "寒晶護幕", type: "buff", tier: 8, mp: 20, dur: 32, noRefresh: true, d: { resWater: 20 }, incomingDmgMult: 0.8, desc: "僅裝備冰之女王的耳環 Lv8 時可使用。", msg: "寒晶凝成護幕，冰冷光芒環繞著你。" },
        ...
        // ⚡ 克特之劍＋盾組合技能：沿用既有「極道落雷→審判落雷」互動，喚回風之洞穴主人的裁決。
        "sk_kurt_thunder_edict": { n: "雷霆敕令", type: "buff", tier: 9, mp: 24, dur: 32, noRefresh: true, d: { resWind: 15 }, kurtJudgmentFlatBonus: 60, desc: "審判落雷的固定傷害加值 +60（+60 → +120）。僅同時裝備克特之劍與克特之盾時可使用。", msg: "盾面雷鳴回應劍鋒，克特的裁決再次落下。" },
