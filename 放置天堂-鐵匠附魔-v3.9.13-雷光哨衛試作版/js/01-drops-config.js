...
function d2rHuntDamage(owner,target,dmg) {
    let t=d2rHuntTotals(owner), pct=target&&target.boss?t.bd:t.nd;
    return Math.max(1,Math.floor((Number(dmg)||0)*(1+pct/100)));
}
...
function d2rTriggerIncoming(owner,dmg) {
...
function d2rRerollSingleAffix(item,index,mode) {
    ...
    if(mode==='type'){
        ...
        const special=new Set(['as','ff','fw','fa','fe','ph','pm','kx','ts','pi','ks','hy','hd','st','os','cb','mcx','gd','scd','ww','wd','wr','wc','ld','ls','lc','lr','bh','bn','bt','bc','shd','shn','sht','shc','vwd','vwn','vws','vwc','fdd','fdn','fdf','fdc','tjd','tjn','tjs','tjc','med','men','mes','mec','rbd','rbn','rbf','rbc','ard','arn','arc','acd','csd','csn','csp','csc','mzd','mzn','mzt','mzc','trd','trn','trt','trc']),gameplay=new Set(['sp','fh']);
...
function d2rRollAffixes(def, options) {
    ...
    const specialCodes = new Set(['as','ff','fw','fa','fe','ph','pm','kx','ts','pi','ks','hy','hd','st','os','cb','mcx','gd','scd','ww','wd','wr','wc','ld','ls','lc','lr','bh','bn','bt','bc','shd','shn','sht','shc','vwd','vwn','vws','vwc','fdd','fdn','fdf','fdc','tjd','tjn','tjs','tjc','med','men','mes','mec','rbd','rbn','rbf','rbc','ard','arn','arc','acd','csd','csn','csp','csc','mzd','mzn','mzt','mzc','trd','trn','trt','trc']);
...
function d2rAffixText(row) {
    ...
    if (['mc','rc','gc','mcd','rcd','gcd','hpp','mpp','pot','abr','gf','xf','nd','bd'].includes(r[0])) return `${D2R_AFFIX_LABEL[r[0]]} +${r[1]}%`;
...
const D2R_PREFIX_PREFERRED = new Set(['as','ff','fw','fa','fe','ph','pm','md','rd','mg','mh','rh','gh','rf','rw','re','ra','rn','mf']);
const D2R_SUFFIX_PREFERRED = new Set(['str','dex','con','int','wis','cha','hp','mp','hpr','mpr','wt']);
