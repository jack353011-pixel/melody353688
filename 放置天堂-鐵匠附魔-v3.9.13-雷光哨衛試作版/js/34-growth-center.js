...
(function () {
    ...
    window.renderGrowthCenter = function () {
        ...
        #growth-center-modal .gc-orb-summary{display:flex;gap:10px;align-items:center;flex-wrap:wrap;padding:12px;margin-bottom:12px;background:#312e81;border:1px solid #a855f7;border-radius:10px}.gc-orb-summary>b{color:#f0abfc}.gc-orb-summary>span{flex:1;color:#c4b5fd}.gc-orb-slots,.gc-orb-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-bottom:16px}.gc-orb-grid{grid-template-columns:repeat(2,1fr)}.gc-orb-slot,.gc-orb-card{display:grid;gap:7px;padding:12px;background:#1e293b;border:1px solid #475569;border-radius:10px}.gc-orb-slot{border-color:#a16207}.gc-orb-slot small,.gc-orb-card small{color:#94a3b8}.gc-orb-card header{display:flex;justify-content:space-between;gap:8px}.gc-orb-card p{color:#e2e8f0}.gc-orb-card details p{color:#c4b5fd}.gc-orb-card>div{display:flex;gap:7px;align-items:center}.gc-orb-card.locked{opacity:.68}.gc-orbs>h3{color:#f0abfc;font-weight:bold;margin-bottom:8px}
        @media(max-width:700px){#growth-center-modal .gc-row,#growth-center-modal .gc-card,.gc-enchant-item{grid-template-columns:1fr}.gc-stat-buttons,.gc-d2r-grid,.gc-orb-grid,.gc-orb-slots{grid-template-columns:1fr}.gc-d2r-group{grid-template-columns:1fr}#growth-center-modal .gc-repair-action{flex-direction:column;align-items:stretch}#growth-center-modal .gc-repair-action button{width:100%;min-height:48px;font-size:16px}#growth-center-modal .gc-repair-action span{text-align:center;font-size:13px}#growth-center-modal .gc-alchemy-fuse{grid-template-columns:1fr}#growth-center-modal .gc-alchemy-fuse>span{text-align:center}#growth-center-modal .gc-alchemy-fuse button,#growth-center-modal .gc-alchemy-fuse select{width:100%;min-height:46px}#growth-center-modal .gc-alchemy-status{flex-direction:column}.gc-orb-summary{align-items:stretch;flex-direction:column}.gc-orb-summary button,.gc-orb-slot button,.gc-orb-card button{min-height:46px}.gc-orb-card header{flex-direction:column}}
