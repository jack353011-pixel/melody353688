...
(function () {
    ...
    function d2rOverviewPanel() {
        ...
        let all = typeof d2rEquipTotals === 'function' ? d2rEquipTotals(player) : {}, groups=[
            ['攻擊／節奏','md,rd,mg,mh,rh,gh,as,mc,rc,gc,mcd,rcd,gcd,fpen,wpen,epen,apen,sdm,und,dem,dra,hsk,opn,exe,ber,fmp,shp,kfu,frz,brn,psn,bld,ctl,deb'],
