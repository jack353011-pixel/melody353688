...
DB.items[W]={
 ...
 type:'wpn',dmgS:30,dmgL:36,hit:2,dmgBonus:5,spd:.9,req:'warrior',safe:6,
 p:380000,gachaWeight:5,core:'whirlwind',d:'咆哮延伸：消耗35怒氣施展炫風斬，持續旋轉攻擊全體敵人。基礎持續4秒、冷卻10秒；原本咆哮傷害完全保留。古代巨人5%掉落。'
};
function weapon(){let i=player&&player.eq&&player.eq.wpn,d=i&&DB.items[i.id];return d&&d.core==='whirlwind'?d:null}
