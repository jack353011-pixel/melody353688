...
(function () {
    ...
    const ITEM_FRAGMENTS = Object.freeze({
        ...
        item_orc_amulet: {
            no: '94', title: '護身符上的五道共獵刻痕',
            lines: [
                '妖魔戰士護身符邊緣刻著甘地、羅孚、都達瑪拉、那魯加與阿吐巴五個部族的記號；中央骨片則取自同一頭巨獸。',
                '五族共同圍獵的功績被分成護身符，但最大的骨架只會立在勝者屋頂。妖魔城堡用骨頭衡量力量，沒有說明取得那根骨頭時有多少雙手一起拉住獵繩。'
            ]
        },
        acc_royal_guard: {
            no: '97', title: '被改成賞賜的伴戒',
            lines: [
                '守護者戒指內圈有兩層刻痕：較新的銘文寫著「近身守護」，底下被磨掉的舊紋則與二十年前聯姻草案所附的伴戒圖樣一致。',
                '舊紋沒有留下姓名，只有兩個尚未合攏的印記。婚約失敗後，其中一枚戒指被重新刻字，從結盟的信物變成效忠王室的賞賜。'
            ]
        },
        wpn_dragonslayer: {
            no: '99', title: '屠龍劍刃上的四個凹槽',
            lines: [
                '屠龍劍的四個凹槽並非戰鬥缺口，尺寸分別吻合地、水、火、風四種封印石；槽內留下的反覆磨痕，更像某種曾被多次插入與取出的校準工具。',
                '劍身找不到千年前的龍血，只有後來重鑄劍柄時才加上的「屠龍」銘文。它也許曾靠近四龍，但用途未必是把劍刺進牠們體內。'
            ]
        },
        acc_icequeen_ear_0: {
            no: '103', title: '被刮掉署名的第一道精煉',
            lines: [
                '冰之女王耳環的雛形刻著八道精煉刻度；最初三道使用的冰晶比例，與象牙塔古亞丁時期的寒冰術課程完全相同。',
                '配方旁原本有一行署名，如今只剩刮痕。後來工匠保留每一個數字，卻把提供這套方法的人從耳環與教材上一起除去。'
            ]
        }
    });
    ...
    const AREA_EXTRA_FRAGMENTS = Object.freeze({
        ...
        elf_forest: Object.freeze([{
            ...
            no: '93', title: '會在夜裡換屋頂的梁骨', source: '地區・妖魔森林',
            lines: [
                '幾根巨獸梁骨的底座疊著不同部族的刻名，舊名被刮掉後又刻上新名；搬運溝從敗者住屋一路拖向首領高屋。',
                '骨架數量確實代表主人當下的實力，但骨頭不必由主人親手獵得。挑戰勝利、部族合併或掠奪，都能讓同一根梁骨在一夜之間替另一個名字作證。'
            ]
        }]),
        heine: Object.freeze([{
        ...
        town_giran: Object.freeze([{
            ...
            no: '96', title: '聯姻草案背面的三份估價', source: '地區・奇岩城鎮',
            lines: [
                '奇岩地下帳藏著一張與肯特聯姻草案同日的估價紙。正面把婚約寫成血統與和平，背面卻逐項計算港稅、糧隊護送權與「實際控制領地」獲得王室承認後的價值。',
                '紙上沒有聯姻雙方的姓名，只有商會留下的價格。二十年前有人想用婚約穩住權力，也有人早已準備把這份穩定拆成可以抵押的收入。'
            ]
        }]),
        dragon_valley: Object.freeze([{
            no: '100', title: '從龍之谷分出去的四條維修線', source: '地區・龍之谷',
            lines: [
                '谷底石圖沒有畫出一座完整封龍陣，而是以四條不同記號的路線分別指向地底、海音水域、火龍窟與一座早已倒塌的高空瞭望台。',
                '地、火、風三線只有世代磨損，水線卻疊著數百年前的急修刻痕。四龍不是被關在同一座牢籠；四處封印各自需要有人抵達、檢查與修補。'
            ]
        }]),
        town_oren: Object.freeze([{
            no: '102', title: '從學徒名冊延伸出去的席位', source: '地區・歐瑞村莊',
            lines: [
                '歐瑞畢業名冊背面不是成績，而是一張任職圖：王室顧問、城主術士、軍隊魔法官與地方教師的席位，都以細線連回象牙塔的同一批訓練編號。',
                '象牙塔不必直接統治城鎮。只要各地都需要它認可的法師，塔內決定何種知識算正統的那一天，王國各處便會使用相同答案。'
            ]
        }]),
    ...
    const MOB_FRAGMENTS = Object.freeze({
        ...
        '阿吐巴妖魔': {
            no: '95', title: '阿吐巴腰間的梁骨名牌', source: '擊敗・阿吐巴妖魔',
            lines: [
                '阿吐巴腰間掛著十二枚梁骨名牌，其中九枚背面仍留著其他部族沒有磨淨的刻痕；名牌不是獵殺紀錄，而是目前的所有權。',
                '最後一枚留白，旁邊刻著「勝者帶走」。在這座骨城裡，擊敗強者不只奪走位置，也會讓他的屋頂、獵物與過去共同完成的功績一起改名。'
            ]
        },
        '巴拉卡斯': {
    ...
    const NPC_EXTRA_FRAGMENTS = Object.freeze({
        ...
        npc_wh_giran: Object.freeze([{
            no: '98', requires: ['43', '44', '48', '66', '96', '97'], title: '二十年沒有人認領的婚箱', source: '追問・蘇瑞耳',
            lead: '蘇瑞耳只承認倉庫裡有一只逾期商業寄存箱。先找齊旁支族譜、流放命令、城籍名冊、王室借款、聯姻估價與被改刻的伴戒，證明它們都指向二十年前同一份未完成的交易，他才會核對封條。',
            lines: [
                '婚箱封條與奇岩地下帳的商會印完全吻合。箱內沒有嫁衣，只有兩個戒槽、三份未生效的權利契約，以及一張規定「雙方簽署後才可交付」的倉單。',
                '蘇瑞耳沒有猜測本應站在婚約兩端的人，只指出其中一個戒槽與守護者戒指大小相同。二十年前沒有人完成簽署；權力以流放與借款重新分配後，箱子便再也無人來領。'
            ]
        }]),
        npc_mimi: Object.freeze([{
            no: '101', requires: ['07', '20', '32', '33', '34', '35', '40', '99', '100'], title: '鍛造師認得的不是屠殺工具', source: '追問・米米',
            lead: '米米不肯只憑傳說判斷屠龍劍。先找齊四道龍印、水龍修復碑、火龍窟試煉階梯、龍之谷維修線與劍上的四個凹槽，她才願意用古代龍鱗鍛造法比對工具痕跡。',
            lines: [
                '米米把四種龍鱗依序嵌進劍槽，發現劍身會分別發出與四道封印相同的低鳴。它不能控制巨龍，只能讓維護者知道眼前的封印是否仍與千年前的基準一致。',
                '「若是屠龍，傳說只需要一名英雄。」她取下龍鱗，「若是四處封印，世界需要的是每一代都有人走完四條路。」劍名記住一次勝利，磨痕卻記住了長久維護。'
            ]
        }]),
        npc_david: Object.freeze([{
            no: '104', requires: ['05', '06', '18', '19', '31', '41', '42', '70', '102', '103'], title: '大衛只敢保留沒有名字的工法', source: '追問・大衛',
            lead: '大衛說精煉只看配方，不問歷史。先找齊冰之女王的魔杖與結晶、王室捐獻簿、除名痕跡、象牙塔兩個年代的證據室、歐瑞任職圖，以及耳環上被刮掉的第一道精煉，他才肯翻出工坊沿用的舊配方。',
            lines: [
                '大衛把耳環刻度與舊配方重疊，確認最初三道精煉從古亞丁時期沿用至今。捐獻者欄被整齊裁去，材料數量與操作步驟卻一字未改，因為少掉任何一項，寒冰結晶都會在加工時碎裂。',
                '「象牙塔沒有丟掉被除名者留下的知識。」他把沒有署名的配方收回抽屜，「它只把能重複使用的部分叫做方法，把不能再出現的部分叫做人名。」'
            ]
        }])
    });
    ...
    const LORE_THEORIES = Object.freeze([
        ...
        {
            no: 'XXIII', requires: ['39', '46', '75', '76', '77', '93', '94', '95'], title: '妖魔城堡把共同獵物寫成個人力量',
            text: '妖魔砍林築城，以巨獸骨架公開標示強弱；五族共獵、梁骨改名與勝者繼承名牌則證明，建築展示的不是單純戰績，而是當下誰有能力佔有集體成果。骨架制度能在王國之外維持秩序，也和王國史冊一樣，會讓最後握住名字的人看起來獨自完成了一切。'
        },
        {
            no: 'XXIV', requires: ['43', '44', '48', '59', '66', '96', '97', '98'], title: '聯姻不是和解，而是一份權力抵押',
            text: '未簽的婚約把旁支血統、城池合法性、港稅、糧運與商會資金綁在同一只婚箱裡。線索仍不足以確認聯姻雙方，卻足以看出它不是單純的感情或和解；當婚約失敗，原本想交換的權力沒有消失，只改由流放、軍餉借款與效忠賞賜重新分配。'
        },
        {
            no: 'XXV', requires: ['07', '20', '32', '33', '34', '35', '40', '99', '100', '101'], title: '屠龍傳說把長久維護改寫成一次勝利',
            text: '四龍被分別封印，四條維修線、屠龍劍的校準槽與水印上的急修痕跡都說明封印並非完成後便永遠穩固。把工具稱為屠龍劍，能讓歷史只剩英雄與勝利；把磨痕、道路和守封者的名字放回來，才看得見千年封印其實由無數次沒有被歌頌的維護延續。'
        },
        {
            no: 'XXVI', requires: ['05', '06', '18', '19', '31', '41', '42', '70', '102', '103', '104'], title: '象牙塔最穩固的權力是把人名變成方法',
            text: '歐瑞把受訓法師送進王室、城主、軍隊與地方學校，也決定哪些證據與課程能被留下。冰之女王遭除名後，她提供的材料與精煉法仍以無名配方繼續教授；象牙塔不必燒掉知識，只要保留可用的方法、刪去不利的人名，後世便會把權力選過的證據當成自然形成的真相。'
        }
    ]);
