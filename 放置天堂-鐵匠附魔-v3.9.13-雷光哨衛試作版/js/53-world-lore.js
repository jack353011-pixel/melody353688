...
(function () {
    ...
    const ITEM_FRAGMENTS = Object.freeze({
        ...
        new_item_145: {
            no: '77', title: '第一桶金上的血痕',
            lines: [
                '阿吐巴圖騰背面疊著獵人、收購者與地下商人的三種記號；每一道都代表它曾在燃柳村換過一次手。',
                '這是妖魔圖騰中最值錢的一種。村裡說「想賺第一桶金，就去燃柳」；但圖騰沾著的血，並不總是妖魔的。'
            ]
        },
        arm_107: {
            no: '85', title: '替水閘擋過洪流的盾',
            lines: [
                '伊娃之盾內側刻的不是禱文，而是海音各段水道的刻度；盾緣幾處凹痕，正好吻合舊水閘用來固定閘板的卡榫。',
                '水龍侵襲時，神殿把祝福過的盾交給守閘人。它們曾是祭器，也是水都來不及打造新零件時，撐住閘門的最後一塊鐵。'
            ]
        },
        bot_baless: {
            no: '88', title: '靴跟裡的井道圖',
            lines: [
                '巴列斯長靴的夾層藏著一張微縮井道圖，七個井口與風木城的舊井名冊完全吻合；圖上另畫出從乾井底部通往地監的維修道。',
                '幾條維修道被後來墨水改成召喚陣的供給線。巴列斯不必穿越沙漠運送物資，他把風木賴以生存的地下水路，變成了研究室看不見的後門。'
            ]
        }
    });
    ...
    const AREA_EXTRA_FRAGMENTS = Object.freeze({
        zone_14: Object.freeze([{
            no: '78', title: '一座陣的三種用法', source: '地區・說話之島地監2樓',
            lines: [
                '海潮後的古代魔法陣留著三組不同的註記：「護送」、「躲避封鎖」與「不記名渡海」；術式全都指向大陸的古魯丁地監。',
                '開路的魔法師沒有留下誰才有資格使用它。同一條秘密通道能保護被追捕的人，也能讓追捕中的人消失。'
            ]
        }]),
        town_gludio: Object.freeze([{
            no: '75', title: '沒有守衛的防線', source: '地區・燃柳村',
            lines: [
                '村口半倒的肯特界碑後藏著舊箭孔；燃柳最初不是村莊，而是肯特為阻擋妖魔入侵搭起的臨時防衛點。',
                '現在少了駐守軍與守衛，原本被防線擋在外面的人反而聚進來，把廢棚變成沒有人追問身分的交易地。'
            ]
        }, {
            no: '76', title: '城堡與森林之間的小路', source: '地區・燃柳村',
            lines: [
                '燃柳的船貨圖沒有畫海，只畫出妖魔城堡與森林周邊的小路；違法商人與逃亡者用不同符號，卻在村口指向同一張收購桌。',
                '肯特仍把這裡列在領地內，但王國的治安在最後一名守衛離開時就停下了。留下來的秩序只問貨有多少，不問人從哪裡來。'
            ]
        }]),
        ...
        town_aden: Object.freeze([{
            ...
            no: '81', title: '四條街的巡防鐘', source: '地區・亞丁城鎮',
            lines: [
                '巡防簿把十字城的商業區、港口、住宅區與貧民區寫在同一頁；前三區每輪鐘都有守衛落款，第四區只在徵稅日留下腳印。',
                '城圖說四條街同屬亞丁，巡防簿卻記錄著四種不同的安全。王國不曾宣布放棄貧民區，只是很少在那裡出現。'
            ]
        }, {
            no: '82', title: '一場雨的兩張修繕單', source: '地區・亞丁城鎮',
            lines: [
                '暴雨後的主城修繕單優先列出王宮大道、商業區水溝與港口倉庫；另一張用廃紙寫的單子，才記著貧民區塌掉的屋頂。',
                '兩張單子在同一天送入官署，前者蓋了「立即處理」，後者只被抄進下一季的預算。貧富不均不需要寫在法律裡，只要決定哪裡先修。'
            ]
        }, {
            no: '83', title: '王宮倉庫前的車轍', source: '地區・亞丁城鎮',
            lines: [
                '從港口卸下的貨物穿過商業區與住宅區，最後在王宮倉庫前留下最深的車轍；唯一不被貨車穿過的，是被金箔蓋住的那條街。',
                '貧民區的工人在碼頭搬貨、在商鋪修車，卻得繞過王城向外的圍牆才能回家。萬城之城依靠四條街運作，只讓三條留在訪客眼前。'
            ]
        }]),
        talking_island_port: Object.freeze([{
            ...
            no: '79', title: '名單外的到岸印', source: '地區・說話之島港口',
            lines: [
                '港務員把未獲准登船的旅客全數畫掉；幾天後，其中幾個名字卻出現在大陸貨棧的簽收印上，找不到他們搭過的船。',
                '王室將正式航線管得越緊，港口帳本就越完整；但帳本之外的人並未消失，只是開始尋找不會被登記的路。'
            ]
        }]),
        ...
        town_heine: Object.freeze([{
            ...
            no: '84', title: '禱詞背面的水閘時刻', source: '地區・海音城鎮',
            lines: [
                '伊娃神殿的早晚禱詞背面，逐行抄著水閘開閉時刻；潮水升高時，鐘聲的長短不是儀式，而是通知各區守閘人依序放水。',
                '海音人把維持水道的方法編進每日祈禱。信仰沒有替城市阻止洪水，卻讓每一代居民都記得洪水來時該先打開哪一道閘門。'
            ]
        }]),
        ...
        kent: Object.freeze([{
            no: '90', title: '被軍道切斷的第三壟', source: '地區・肯特周邊',
            lines: [
                '肯特農地每三壟便有一壟被壓成運糧軍道；田界碑仍把那塊土地算進農戶收成，徵糧官卻不扣除車輪與軍靴毀掉的作物。',
                '農戶不只交出穀物，也交出讓穀物運往城塞的土地。肯特的肥沃不是自然留給軍隊的禮物，而是有人年年少種一壟換來的道路。'
            ]
        }]),
        town_windwood_castle: Object.freeze([{
            no: '87', title: '城牆圍住的七口井', source: '地區・風木城',
            lines: [
                '風木最舊的守備圖先標七口井，才畫城門與箭塔；守軍輪值也不按城牆分區，而是依每口井剩餘的水位安排。',
                '商隊能否入城、居民何時領水，都由同一張井況表決定。荒野裡的城牆看似保護領土，真正被圍在中央的卻是能讓城市多活一天的水。'
            ]
        }]),
        town_kent_castle: Object.freeze([{
            ...
            no: '91', title: '糧庫裡的兩只量斗', source: '地區・肯特城',
            lines: [
                '肯特糧庫收糧用的木斗比發糧斗深一指。帳面上農戶交出一斗、士兵領走一斗，實際留下的差額則被記成「守城耗損」。',
                '兩只斗都蓋著合法官印，也都沒有寫錯數字。肯特能在圍城時多撐數日，是因為同一個「一斗」在城門內外從來不是同樣的重量。'
            ]
        }])
    });
    ...
    const NPC_EXTRA_FRAGMENTS = Object.freeze({
        npc_gilen: Object.freeze([{
            ...
            no: '80', requires: ['01', '10', '36', '45', '49', '78', '79'], title: '吉倫隱瞞的不是出口', source: '再問・吉倫',
            lead: '吉倫已經承認兩條離島路，卻不肯解釋水底隧道的用途。找齊魔法陣上的三種註記、港口名單外的到岸印與歐林的逃亡記錄，他才會回答這條路究竟保護過誰。',
            lines: [
                '吉倫將護送註記、無船到岸印與歐林日記排在同一張地圖上：水底隧道救過躲避封鎖的人，也讓參與禁忌實驗的逃亡者躲過追捕。',
                '「我隱瞞的不是出口。」吉倫指向這些互相矛盾的使用記錄，「是知道出口以後，你必須決定要為誰打開它。」'
            ]
        }, {
        ...
        npc_lumiel: Object.freeze([{
            no: '86', requires: ['20', '33', '64', '84', '85'], title: '祝福落在守閘人的手上', source: '追問・琉米埃爾',
            lead: '琉米埃爾不願把伊娃的祝福說成神蹟。先讀過海音修復碑、水龍封印、神殿重建簿與水閘時刻，再帶回留有卡榫痕跡的伊娃之盾，她才肯解釋受祝福的裝備曾如何保住水都。',
            lines: [
                '琉米埃爾確認盾緣的傷痕不是戰鬥所留。當水龍掀起洪流，祭司敲鐘傳遞閘令，工匠修補斷裂機構，守閘人便用伊娃之盾頂住來不及更換的閘板。',
                '「祝福不是讓鐵自己擋住水。」她把盾交還給你，「是讓拿盾的人相信這道閘不能丟，也讓城裡的人記得該來幫他。」'
            ]
        }]),
        npc_ww_guard: Object.freeze([{
            no: '89', requires: ['04', '30', '38', '65', '87', '88'], title: '守軍不知道井底住著誰', source: '追問・風木傭兵隊長',
            lead: '傭兵隊長只承認井道是城內維修設施。先找齊風木配水牌、七口井的守備圖、巴列斯地監研究台與藏在長靴裡的井道圖，再證明巴列斯曾被象牙塔除名，他才會重查守軍多年來巡視的井底。',
            lines: [
                '傭兵隊長把長靴裡的圖與守備圖疊合，確認巴列斯利用乾井維修道避開地表巡邏，並從仍在使用的井道取得水、空氣與運送召喚材料的路。',
                '歷任守軍每天記錄井口，卻從未被命令追查井底。「我們守住了風木的水，」他封起通往地監的舊支道，「也因此替他守住了一座研究室。」'
            ]
        }]),
        npc_wh_kent: Object.freeze([{
            no: '92', requires: ['24', '48', '52', '57', '61', '90', '91'], title: '巴歐不敢換掉那只斗', source: '追問・巴歐',
            lead: '巴歐說倉庫只照官印與帳冊辦事。先查過肯特的糧田、城籍、守衛制度、被刪改的救濟命令與兩只量斗，證明「守城耗損」不是單次誤差，他才會打開不交給新城主的舊庫簿。',
            lines: [
                '巴歐承認兩只量斗沿用過數任城主：差額一部分補足圍城損耗，一部分供應沒有列入公開兵員帳的部隊。每次政權易手，新主人都譴責舊帳，最後仍蓋回相同官印。',
                '他不敢自行換斗，因為第一年帳面就會少出一支軍隊的口糧。「肯特不是先有糧才有兵，」巴歐闔上庫簿，「是先決定要養多少兵，再讓每一斗糧變成夠用的重量。」'
            ]
        }])
    });
    ...
    const LORE_THEORIES = Object.freeze([
        ...
        {
            no: 'XVII', requires: ['24', '46', '48', '52', '75', '76', '77'], title: '王國的邊界在燃柳變成市場',
            text: '肯特曾用燃柳阻擋妖魔，卻沒有讓守衛、法律與治安留下來。妖魔城堡、森林小路與圖騰收購桌連成了另一套秩序：王國在名冊上擁有這裡，真正管理每天生活的卻是金幣與風險。'
        },
        {
            no: 'XVIII', requires: ['01', '10', '14', '45', '49', '78', '79', '80'], title: '封鎖創造了第二條航線',
            text: '王室的船保護旅客與貨物，也查驗人名、抽取收入並阻止未獲准者離島。魔法師的水底隧道讓人躲過封鎖，同時也曾幫助歐林逃過追捕。一條路是否正當，不只取決於誰造了它，還取決於誰能決定它為誰打開。'
        },
        {
            no: 'XIX', requires: ['15', '25', '44', '56', '63', '66', '81', '82', '83'], title: '萬城之城只展示三條街',
            text: '亞丁的十字城同時包含王宮、商業區、港口、住宅區與貧民區，但守衛、修繕與貨運路線將資源不斷引向前四者。貧民區沒有被建在王國外面；它被建在首都內，卻只在徵稅、勞動與需要付出代價時被當成城市的一部分。'
        },
        {
            no: 'XX', requires: ['20', '33', '47', '64', '68', '84', '85', '86'], title: '海音把信仰寫進每一道閘門',
            text: '海音以伊娃信仰理解水，也把水閘時刻、警報鐘聲、工匠技藝與守閘責任編進信仰。水龍來襲時真正托住城市的是祭司、工匠、守閘人與城外援軍的行動；神話讓人記得水都曾被拯救，完整的殘響則讓人看見是誰伸手托住了它。'
        },
        {
            no: 'XXI', requires: ['04', '30', '38', '65', '87', '88', '89'], title: '風木的城牆守著井，巴列斯守著井底',
            text: '風木在沙漠中把城防、商隊與配水都繫在七口井上；同一套維持城市生存的井道，也讓巴列斯能避開地表運送物資、繼續被象牙塔禁止的研究。資源匱乏沒有阻止地下實驗，因為實驗正寄生在所有人不敢失去的生存系統裡。'
        },
        {
            no: 'XXII', requires: ['24', '48', '52', '57', '61', '90', '91', '92'], title: '肯特的軍隊站在兩只不同的量斗上',
            text: '肯特的農地、軍道、糧庫與守軍不是四件事，而是一條被制度連起來的供糧線。農戶承擔被軍道切走的收成，糧庫用兩種容量留下差額，城主與守衛再把差額變成公開或不公開的兵力；肥沃土地確實養活軍隊，但「肥沃」掩住了誰被要求少留一口糧。'
        }
    ]);
