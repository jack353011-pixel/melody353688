...
function crown(){return typeof buildFlowSource==='function'?buildFlowSource(player,'royalCommand'):null}
...
function deploy(){ensure();if(!crown()||player.cls!=='royal'||player.dead)return false;let b=bonus();player.royalCommandLeft314=Math.round(300*(1+b.time/100));player.royalCommandNext314=1;if(typeof logCombat==='function')logCombat('<span class="text-amber-200 font-bold">【王者號令流派】</span>王旗展開，傭兵接受你的號令！','player-special');badge();return true}
