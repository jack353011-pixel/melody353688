// 👑🛡️🐉 王者劍氣／不屈堡壘／雷龍風暴配套裝備 v3.9.72：同流派最多兩項主要專精生效。
(function(){
'use strict';
...
Object.assign(DB.items,{
 'hlm_royal_valor_crown':{
  ...
  p:230000,gachaWeight:5,royalValorChance:10,flowSupport:'royalValorBlade',flowSupportLabel:'觸發機率',
  d:'王者劍氣配套裝備。設為「流派:王者劍氣」主要專精時，王者劍氣觸發機率 +10%。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由勇猛意志＋單手劍啟動，不要求指定核心武器。克特 2% 掉落。可正常獲得詞綴、洞數與寶石效果。'
 },
 'clk_royal_lion_mantle':{
  ...
  p:240000,gachaWeight:5,royalValorDamagePct:20,flowSupport:'royalValorBlade',flowSupportLabel:'劍氣傷害',
  d:'王者劍氣配套裝備。設為「流派:王者劍氣」主要專精時，王者劍氣傷害 +20%。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由勇猛意志＋單手劍啟動，不要求指定核心武器。克特 2% 掉落。可正常獲得詞綴、洞數與寶石效果。'
 },
 'glv_royal_swordwind':{
  ...
  p:250000,gachaWeight:5,royalValorExtraWaves:1,flowSupport:'royalValorBlade',flowSupportLabel:'額外劍氣',
  d:'王者劍氣配套裝備。設為「流派:王者劍氣」主要專精時，每次發動額外斬出 1 道王者劍氣。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由勇猛意志＋單手劍啟動，不要求指定核心武器。克特 2% 掉落。可正常獲得詞綴、洞數與寶石效果。'
 },
 'amu_royal_oath':{
  ...
  p:290000,gachaWeight:5,royalValorCooldownPct:20,flowSupport:'royalValorBlade',flowSupportLabel:'發動間隔',
  d:'王者劍氣配套裝備。設為「流派:王者劍氣」主要專精時，王者劍氣發動間隔縮短 20%。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由勇猛意志＋單手劍啟動，不要求指定核心武器。克特 2% 掉落。可正常獲得裝備詞綴。'
 },
 ...
 'hlm_unyielding_bastion':{
  ...
  p:230000,gachaWeight:5,unyieldingHitsReduced:1,flowSupport:'unyieldingFortress',flowSupportLabel:'蓄力次數',
  d:'不屈堡壘配套裝備。設為「流派:不屈堡壘」主要專精時，觸發所需承傷次數 -1。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由增幅防禦＋任意盔甲啟動，不要求指定核心盔甲。古代巨人 2% 掉落。可正常獲得詞綴、洞數與寶石效果。'
 },
 'shd_unyielding_bulwark':{
  ...
  p:270000,gachaWeight:5,unyieldingShieldPct:5,flowSupport:'unyieldingFortress',flowSupportLabel:'護盾強度',
  d:'不屈堡壘配套裝備。設為「流派:不屈堡壘」主要專精時，護盾增加 5% 最大生命。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由增幅防禦＋任意盔甲啟動，不要求指定核心盔甲。古代巨人 2% 掉落。可正常獲得詞綴、洞數與寶石效果。'
 },
 'glv_unyielding_impact':{
  ...
  p:250000,gachaWeight:5,unyieldingDamagePct:20,flowSupport:'unyieldingFortress',flowSupportLabel:'震波傷害',
  d:'不屈堡壘配套裝備。設為「流派:不屈堡壘」主要專精時，堡壘震波傷害 +20%。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由增幅防禦＋任意盔甲啟動，不要求指定核心盔甲。古代巨人 2% 掉落。可正常獲得詞綴、洞數與寶石效果。'
 },
 'bot_unyielding_march':{
  ...
  p:260000,gachaWeight:5,unyieldingCooldownPct:20,flowSupport:'unyieldingFortress',flowSupportLabel:'冷卻縮短',
  d:'不屈堡壘配套裝備。設為「流派:不屈堡壘」主要專精時，冷卻縮短 20%。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由增幅防禦＋任意盔甲啟動，不要求指定核心盔甲。古代巨人 2% 掉落。可正常獲得詞綴、洞數與寶石效果。'
 },
 ...
 'hlm_thunder_dragon_horn':{
  ...
  p:240000,gachaWeight:5,thunderDragonDurationPct:25,flowSupport:'thunderDragonStorm',flowSupportLabel:'風暴持續',
  d:'雷龍風暴配套裝備。設為「流派:雷龍風暴」主要專精時，持續時間 +25%。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由奪命之雷＋任意鎖鏈劍啟動，不要求指定核心武器。林德拜爾 2% 掉落。可正常獲得詞綴、洞數與寶石效果。'
 },
 'clk_thunder_dragon_tempest':{
  ...
  p:250000,gachaWeight:5,thunderDragonDamagePct:20,flowSupport:'thunderDragonStorm',flowSupportLabel:'風暴傷害',
  d:'雷龍風暴配套裝備。設為「流派:雷龍風暴」主要專精時，雷龍風暴傷害 +20%。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由奪命之雷＋任意鎖鏈劍啟動，不要求指定核心武器。林德拜爾 2% 掉落。可正常獲得詞綴、洞數與寶石效果。'
 },
 'glv_thunder_dragon_spine':{
  ...
  p:260000,gachaWeight:5,thunderDragonExtraBolts:1,flowSupport:'thunderDragonStorm',flowSupportLabel:'額外雷束',
  d:'雷龍風暴配套裝備。設為「流派:雷龍風暴」主要專精時，每次雷暴脈衝額外降下 1 道雷束。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由奪命之雷＋任意鎖鏈劍啟動，不要求指定核心武器。林德拜爾 2% 掉落。可正常獲得詞綴、洞數與寶石效果。'
 },
 'bot_thunder_dragon_step':{
  ...
  p:260000,gachaWeight:5,thunderDragonCadencePct:20,flowSupport:'thunderDragonStorm',flowSupportLabel:'脈衝頻率',
  d:'雷龍風暴配套裝備。設為「流派:雷龍風暴」主要專精時，雷暴脈衝間隔縮短 20%；與詞綴合計後最低為 0.3 秒。同流派最多啟用 2 項主要專精；其餘裝備能力照常生效。流派由奪命之雷＋任意鎖鏈劍啟動，不要求指定核心武器。林德拜爾 2% 掉落。可正常獲得詞綴、洞數與寶石效果。'
 }
});
