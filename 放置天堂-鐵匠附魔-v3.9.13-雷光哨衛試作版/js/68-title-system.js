...
(function (global) {
    ...
    function defaultState() {
        return {
            ...
            equipped:null,
            unlocked:{},
            progress:{ goblinKills:0, valakasKills:0, corruptedAntharasKills:0, siegeWins:{} },
            storyFlags:{}
        };
    }
    ...
    function liveSources() {
        ...
        try { if (typeof global.clanGetModeInfo === 'function') clanInfo = global.clanGetModeInfo(player); } catch (e) {}
        try { if (typeof global.clanGetCastleCity === 'function') castleCity = global.clanGetCastleCity(player); } catch (e) {}
        try { if (typeof global.clanIsLeaderRole === 'function') clanLeader = global.clanIsLeaderRole(player); } catch (e) {}
        let war = null;
        ...
        return {
            ...
            legacyKentWin:!!(player && player.siege && player.siege.result === 'win')
        };
    }
    ...
    function refreshDisplay() {
        ...
        let state = sync(true), sources = liveSources(), def = DEFINITION_BY_ID[state.equipped];
        if (button) {
    ...
    function renderPanel() {
        ...
        let state = sync(true), sources = liveSources();
