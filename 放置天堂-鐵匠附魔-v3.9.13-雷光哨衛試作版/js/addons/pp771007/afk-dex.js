 ...
 *   - 「掉落率模式」下拉(一般/席琳的世界 ×1.5/瘋狂的席琳世界 ×2.25):重算怪卡掉落率顯示(席琳上限 100%)。
...
(function () {
  ...
  function cardHTML(h, mult, q) {
    var modeLabel = mult >= 2.25 ? '（瘋狂的席琳世界 ×2.25）' : (mult > 1 ? '（席琳的世界 ×1.5）' : '');
    var m = h.mob;
    var tags = '';
  ...
  var SPECIAL_BLOCKS = [
    { id: 'dropmult', title: '🔮 掉落倍率：席琳的世界 ×1.5、瘋狂的席琳世界 ×2.25、恩賜怪 ×10', keys: ['掉落倍率', '倍率', '席琳的世界', '瘋狂的席琳世界', '經典模式', '恩賜怪', '恩賜'], lines: [
      '<b>怪物卡上顯示的是「一般」掉落機率</b>，下列狀態會整體放大／縮小：',
      '<b>席琳的世界</b>：被席琳化的怪掉落機率 <b>×1.5</b>（<b>瘋狂的席琳世界</b> <b>×2.25</b>）；其中「恩賜怪」更高，<b>×10</b>',
      '<b>經典模式</b>：掉落機率<b>與一般模式完全相同</b>，不打任何折',
      '<b>固定、不受倍率影響的例外</b>：怪物卡片（普／銀／金卡）、萬能藥（屬性藥）、黑魔石、銀礦石（各條另有標註）；其餘怪卡掉落都會被倍率放大／縮小',
      '<b>席琳結晶</b>比較特別：不吃「席琳掉落倍率」、隊伍人數與「恩賜怪 ×10」（機率直接由怪物等級決定），只吃「瘋狂 ×3」；經典模式與它無關（經典角色進不了席琳神殿）——詳見下方席琳結晶那條',
    ...
    { id: 'sherine', title: '🔮 席琳結晶（席琳的世界限定）', keys: ['席琳結晶'], lines: [
      ...
      '倍率：<b>不受</b>席琳掉落倍率、隊伍人數與「恩賜怪 ×10」影響；<b>瘋狂的席琳世界 ×3</b>',
      '頭目保底：席琳世界 <b>100 次</b>、瘋狂席琳 <b>40 次</b>；兩種難度各自累積，掉落後歸零',
    ...
    { id: 'relic', title: '🏺 遺物（各怪專屬的極稀有裝備）', keys: ['遺物', 'relic', '遺物收集冊'], lines: [
      ...
      '機率<b>會吃掉落倍率</b>：席琳的世界 <b>×1.5</b>、瘋狂的席琳世界 <b>×2.25</b>、恩賜怪 <b>×10</b>',
    ...
    m.innerHTML =
      '<div id="m-dex-card-wrap">' +
        ...
        '<div id="m-dex-sherine-row"><label for="m-dex-mode">掉落率模式</label>' +
          '<select id="m-dex-mode"><option value="1">一般模式</option><option value="1.5">席琳的世界（×1.5）</option><option value="2.25">瘋狂的席琳世界（×2.25）</option></select></div>' +
